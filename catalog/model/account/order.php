...
class ModelAccountOrder extends Model {
	...
	public function getOrderSMS($order_id) {
	...
	public function getOrderOptions($order_id, $order_product_id) {
		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "order_option WHERE order_id = '" . (int)$order_id . "' AND order_product_id = '" . (int)$order_product_id . "' ORDER BY type DESC");
	...
	public function getPriceOrderSaleOff($order_id){
