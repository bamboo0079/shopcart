...
<div id="content" class="category"><?php echo $content_top; ?>
  ...
  <div class="product-list-box transitions-enabled">
  	...
  	<div class="item">
        ...
        <div class="cart">
            <a href="<?php echo $product['href']; ?>#booking" class="button_booking">
            <?php if($product['product_type']==0){?>
            <?php echo $button_cart?>
            <?php }else{?>
            <?php echo $button_car_rent?>
            <?php }?>
            </a> 
        </div>
        ...
        <?php if($product['duration'] && $product['thumb']){ ?><span class="time"><?php echo $product['duration']; ?></span><?php }?>
    </div>
    <?php } ?>
  </div>
