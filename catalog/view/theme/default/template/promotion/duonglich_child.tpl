...
<div id="content" class="category"><?php echo $content_top; ?>
    ...
    <div class="promotion_content">
    	...
    	<div class="promotion_col">
        	<p class="title"><?php echo $name_title_duonglich?></p>
            <ul class="product-promotion-list">
                ...
                <li <?php if($count % 2 == 0){ echo 'class="r"';}?>>
                    ...
                    <?php if($item['price']){?><p class="price"> Giá từ: <span><?php echo $item['price']?></span></p><?php }?>
    ...
    <div style="display:none">
        ...
        <div id="list_map">
        	...
        	<?php for ($i = 0; $i < count($cats_duonglich);) { ?>
        	<ul class="list_map_promotion">
            	<?php $j = $i + ceil(count($cats_duonglich) / 4); ?>
          		<?php for (; $i < $j; $i++) { ?>
                <?php if (isset($cats_duonglich[$i])) { ?>
            	<li><a href="<?php echo $cats_duonglich[$i]['href']; ?>" rel="nofollow"><i class="fa fa-map-marker"></i> <?php echo $cats_duonglich[$i]['name']; ?></a></li>
                <?php }?>
                <?php }?>
            </ul>
            <?php } ?>
...
$(document).ready(function() {
	...
	url = '<?php echo $link_promotion_duonglich?>';
