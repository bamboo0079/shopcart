...
<div id="content"><?php echo $content_top; ?>
  ...
  <p class="p-line"><?php echo $text_account_already; ?></p>
  <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
    ...
    <table class="form">
        ...
        <tr>
          ...
          <td><input type="text" name="address_1" value="<?php echo $address_1; ?>" placeholder="<?php echo $text_placeholder_address; ?>" size="30" data-validation="required" data-validation-error-msg="<?php echo $lang_error_address; ?>" autocomplete="off"/>
        ...
        <tr>
          ...
          <td><select name="country_id" style="width:190px;" data-validation="required" data-validation-error-msg="<?php echo $lang_error_country; ?>">
        ...
        <tr>
          ...
          <td><select name="zone_id" style="width:190px;" data-validation="required" data-validation-error-msg="<?php echo $lang_error_zone; ?>">
            </select>
            <?php if ($error_zone) { ?>
    ...
    <div class="content">
      <table class="form">
        <tr>
          ...
          <td><input type="password" name="password_confirmation" value="<?php echo $password_confirmation; ?>" placeholder="<?php echo $text_placeholder_password; ?>" size="30" data-validation="length" data-validation-length="min4" data-validation-error-msg="<?php echo $lang_error_password; ?>"/>
        ...
        <tr>
          ...
          <td><input type="password" name="password" value="<?php echo $password; ?>" placeholder="<?php echo $text_placeholder_confirm; ?>" size="30" data-validation="confirmation length" data-validation-length="min4" data-validation-error-msg="<?php echo $lang_error_confirm; ?>"/>
    ...
    <div class="buttons">
        ...
        <?php } else { ?>
        <input type="checkbox" name="agree" value="1" data-validation="required" data-validation-error-msg="<?php echo $lang_error_agree; ?>"/>
        <?php } ?><?php echo $text_agree; ?></label>
        </div>
    	<div class="right">
