        ...
        <span style="float: right;" class="product_print_button">
            ...
            <a href="<?php echo $print_product?>" target="_blank"><i class="fa fa-print fa-2x"></i></a>
                ...
                <div class="introduction">
                    ...
                    <th colspan="20" style="border-bottom: 1px solid #ccc;background: #02923e;font-family: verdana;">Giá Ngày Lễ - <em>đã giảm</em> <br /><span>(Áp dụng từ ngày <b>23/12/2015</b> đến <b>03/01/2016</b>)</span></th>
                    </tr>
                    <tr>
