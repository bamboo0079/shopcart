...
<div id="content" class="category home"><?php echo $content_top; ?>
    ...
    <div class="promotion_content">
    	...
    	<div class="promotion_col">
        	<p class="title"><?php echo $name_title_he?></p>
    ...
    <div style="display:none">
        ...
        <div id="list_map">
        	...
        	<?php for ($i = 0; $i < count($cats_he);) { ?>
        	<ul class="list_map_promotion">
            	<?php $j = $i + ceil(count($cats_he) / 4); ?>
          		<?php for (; $i < $j; $i++) { ?>
                <?php if (isset($cats_he[$i])) { ?>
            	<li><a href="<?php echo $cats_he[$i]['href']; ?>" rel="nofollow"><i class="fa fa-map-marker"></i> <?php echo $cats_duonglich[$i]['name']; ?></a></li>
                <?php }?>
                <?php }?>
            </ul>
            <?php } ?>
...
$(document).ready(function() {
	...
	url = '<?php echo $link_promotion_he?>';
