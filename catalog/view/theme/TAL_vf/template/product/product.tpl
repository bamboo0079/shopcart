                ...
                <div class="introduction">
                    ...
                    <div id="tab-schedule" class="tab-content">
                        ...
                        <div class="image_promotion_date">
                            ...
                            <a href="http://www.vietfuntravel.com.vn/<?php echo EVENT_SEO; ?>" title="Tour Du Lịch Tết Nguyên Đán 2016" target="_blank"><img border="0" src="<?php if(isset($linkbannergroup)){echo $linkbannergroup;}else{echo 'http://www.vietfuntravel.com.vn/image/data/banner-promotion/nguyendan/banner-tet-nguyen-da-2016.jpg';} ?>" width="100%" alt="Tour Du Lịch Tết Nguyên Đán 2016"></a>
                    ...
                    <div class="title_table_price title_table_price1"><span>Bảng giá khuyến mại <?php echo $promotion_title?> Tết Nguyến Đán</span></div>
                    ...
                    <th colspan="3" style="border-bottom: 1px solid #ccc;background: #E4F8DA;color:#2A7305;">Giá <?php foreach ($options as $option)  { ?>
                                ...
                                <?php break; } ?>
                            <?php } ?></th> </tr>
                    <th colspan="3" style="border-bottom: 1px solid #ccc;background: rgba(250,207,28,0.98);color:#637F04; color:#000; line-height:30px">ĐẶT TOUR <strong style="color:red;font-size:17px;font-style:italic">TRƯỚC</strong> NGÀY KHỞI HÀNH</th> </tr>
                    <tr >
...
<div class="right row2" style="display:none" id="daypayment">
...
<div class="left">
    ...
    <div class="step_title color1"><label>4</label><span>Số lượng khách</span></div>
...
$('.date, .datetime, .time').bgIframe();
  ...
  <?php if ($special) { $promotion_date_start = date('m/d/Y',strtotime($promotion_date_start)); ?>
...
var mindate = date_current.getDate();


$(".list-datepicker").datepicker({gotoCurrent:!0,changeMonth:!0,changeYear:!0,minDate:'+1dd',maxDate:maxdate,numberOfMonths:monthProduct,beforeShowDay: highlightDays,onSelect: chooseDay, dateFormat: 'dd/mm/yy', altField: ".departure"})

function highlightDays(date) {
$(".ui-state-active, .ui-widget-content .ui-state-active, .ui-widget-header .ui-state-active").css('cursor', 'none');
...
//    var product_id = $('input[name=product_id]').val();
    ...
    if(date_ch >= Date.parse('<?php echo $promotion_date_start2; ?>') && date_ch <= Date.parse('<?php echo $promotion_date_end; ?>')){
        ...
        var daypayment = $('input[name="daypayment"]:radio:checked').val();
        $('#dayment').val(daypayment);
        var grouptour = <?php echo $grouptour ?>;
        if(checkevent){
            if(daypayment == 1){
                if(grouptour == 1){
                    var value_down = 70000;
                }
                if(grouptour == 2){
                    var value_down = 106000;
                }
                if(grouptour == 3){
                    var value_down = 279000;
                }
            }
            if(daypayment == 2){
                if(grouptour == 1){
                    var value_down = 86000;
                }
                if(grouptour == 2){
                    var value_down = 126000;
                }
                if(grouptour == 3){
                    var value_down = 329000;
                }
            }
            if(daypayment == 3){
                if(grouptour == 1){
                    var value_down = 117000;
                }
                if(grouptour == 2){
                    var value_down = 158000;
                }
                if(grouptour == 3){
                    var value_down = 379000;
                } 
            }
