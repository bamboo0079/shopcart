        ...
        <div class="order-list">
            ...
            <div class="order-content">
                ...
                <div><b><?php echo $text_customer; ?></b> <?php echo $order['name']; ?><br />
                    <b><?php echo $text_total; ?></b> <span style="color:#b00;font-weight:bold"><?php /* show gia da giam coder by tranminh*/ if($order['total_event'] != '0₫'){ echo $order['total_event'];}else{echo $order['total'];} ?></span></div>
