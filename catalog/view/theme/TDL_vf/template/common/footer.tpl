...
<div class="float_left_ads" id="left_img" style="top:<?php echo $float_ads_top?>px"><?php echo $float_left_ads?></div>
<?php }?>
<?php if($float_right_ads){?>
<div class="float_right_ads" id="right_img" style="top:<?php echo $float_ads_top?>px"><?php echo $float_right_ads?></div>
<?php }?>
<?php }?>
<?php }?>
<noscript>
