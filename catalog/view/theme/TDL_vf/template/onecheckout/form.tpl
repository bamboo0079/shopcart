<div class="note-order note-order-camket"><b>Cam kết:</b> Tôn trọng, bảo mật thông tin cá nhân.</div>
  <div class="left">
    <span class="required">*</span> <?php echo $entry_lastname; ?><br />
    <input type="text" name="lastname" value="<?php echo $lastname; ?>" class="small-field" placeholder="<?php echo $text_placeholder_lastname; ?>" /><br />
  </div>
  <div class="right">
  	<span class="required">*</span> <?php echo $entry_firstname; ?><br />
    <input type="text" name="firstname" value="<?php echo $firstname; ?>" class="small-field" placeholder="<?php echo $text_placeholder_firstname; ?>"/><br />
  </div>  
  <div class="divclear">
  	<div id="birthday-display">
  	<br />
  	<span class="required">*</span> <?php echo $entry_birthday; ?><br />
  	<select name="birthday_day" style="width: 90px;">
    ...
    <select name="birthday_year" style="width: 90px;">
    ...
    <br />
  	...
  	<input type="text" name="email" value="<?php echo $email; ?>" class="large-field" placeholder="<?php echo $text_placeholder_email; ?>"/><br />
    </div>
    <div id="company-display" style="display:none">
    <br />
	...
	<span class="required">*</span> <?php echo $entry_address_1; ?><br />
  	<input type="text" name="address_1" value="<?php echo $address_1; ?>" class="large-field" placeholder="<?php echo $text_placeholder_address; ?>"/>
  	<br />
  </div>
  <br />
  <span class="required">*</span> <?php echo $entry_telephone; ?><br />
  <input type="text" name="telephone" value="<?php echo $telephone; ?>" class="small-field" placeholder="<?php echo $text_placeholder_telephone; ?>"/><br />
...
$('#payment-address select[name=\'birthday_day\']').live('focus', function() {
	errorremove("payment","birthday");
});

$('#payment-address select[name=\'birthday_month\']').live('focus', function() {
	errorremove("payment","birthday");
});

$('#payment-address select[name=\'birthday_year\']').live('focus', function() {
	errorremove("payment","birthday");
});
