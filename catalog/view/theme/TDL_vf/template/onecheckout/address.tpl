<?php if ($addresses) { ?>
<p class="text_logged"><?php echo $text_logged?></p>
<div class="info_payment">
    <p><label><?php echo $entry_fullname?></label><span><?php echo $user['lastname'].' '.$user['firstname']?></span></p>
    <p><label><?php echo $entry_email?></label><span><?php echo $user['email']?></span></p>
    <p><label><?php echo $entry_telephone?></label><span><?php echo $user['telephone']?></span></p>
    <p><label><?php echo $entry_address_1?></label><span><?php echo $payment_address['address_1'].', '.$payment_address['zone'].', '.$payment_address['country']?></span></p>
</div>
...
<div id="<?php echo $type; ?>-existing">
  <select name="address_id" style="width: 100%; margin-bottom: 15px;" size="5">
    ...
    <option value="<?php echo $address['address_id']; ?>" selected="selected"><?php if($address['address_1']){ echo $address['address_1'].', ';} ?><?php echo $address['zone']; ?>, <?php echo $address['country']; ?></option>
    <?php } else { ?>
    <option value="<?php echo $address['address_id']; ?>"><?php if($address['address_1']){ echo $address['address_1'].', ';} ?><?php echo $address['zone']; ?>, <?php echo $address['country']; ?></option>
    <?php } ?>
    <?php } ?>
  </select>
</div>
