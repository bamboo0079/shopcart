        ...
        <span style="float: right;" class="product_print_button">
            ...
            <a href="<?php echo $print_product?>" target="_blank"><i class="fa fa-print fa-2x"></i></a>
                ...
                <div class="introduction">
                    ...
                    <tr>
                    <th rowspan="3" width="23%" style="background: #dcedd2;color:#424c67;font-family: verdana;">Loại</th>
                    <th rowspan="3" width="22%" style="background: #02923e;font-family: verdana;">Giá Tour Ngày Lễ</th>
                    ...
                    <tr>
                        ...
                        <table><tr>
                        <td class="pri check_event_class" style="line-height: 147%;background: #dcedd2;color:black;font-family: verdana;font-weight:200;"><?php echo $option_value['price']; ?><label><?php if(in_array($option['option_id'],$phuthu)){?><?php echo $option_value['name']; ?><?php }else{?>&nbsp;<?php }?></label>
                        </td>
                        </tr></table>
                        <?php } ?>
                        ...
                        <?php foreach ($option['option_value'] as $option_value) { ?>
                        <table><tr>
                        <td class="pri" style="line-height: 147%;background: #dcedd2;color:blue;font-family: verdana;"><?php echo $option_value['price_1']; ?><label><?php if(in_array($option['option_id'],$phuthu)){?><?php echo $option_value['name']; ?><?php }else{?>&nbsp;<?php }?></label>
                        </td>
                        </tr></table>
                        <?php } ?>
                        </td>
                        ...
                        <?php foreach ($option['option_value'] as $option_value) { ?>
                        <table ><tr>
                        <td class="pri" style="line-height: 147%;background: #dcedd2;color:red;font-family: verdana;"><?php echo $option_value['price_2']; ?><label><?php if(in_array($option['option_id'],$phuthu)){?><?php echo $option_value['name']; ?><?php }else{?>&nbsp;<?php }?></label>
                        </td>
                        </tr></table>
                        <?php } ?>
                        </td>
...
<div id="choose-tour">
    ...
    <div class="holy1">
        ...
        <?php foreach ($options as $option) { ?>
        <?php $nangcapks = array('84','99','109','119'); ?>
        <?php if ($option['type'] == 'checkbox' && $option['category'] == '2' && $option['class'] == '0' && in_array($option['option_id'],$nangcapks) == false) { ?>
