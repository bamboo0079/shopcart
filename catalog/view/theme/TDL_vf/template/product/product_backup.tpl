...
<div id="content"> <?php echo $content_top; ?>
  ...
  <div class="product-info">
    ...
    <h1><?php echo $model; ?>: <a href="<?php echo $url?>" title="<?php echo $heading_title; ?>"><?php echo $heading_title; ?></a></h1>
    <div class="left">
      <?php if ($thumb) { ?>
    ...
    <div class="right">
      ...
      <div class="price">
        ...
        <div class="left">
            ...
            <label class="special special2"><?php echo $special; ?></label>
        </div>
        <?php } ?>
      ...
      <div class="description">
        <div class="info">
          <div class="info_title"> <?php if($schedule){ ?>
            <span><i class="fa fa-location-arrow"></i></span> <strong><?php echo $entry_schedule; ?></strong> <?php echo $schedule?>
            <?php }?></div>
          <ul>
            <li><i class="fa fa-key"></i> <strong><?php echo $entry_model; ?></strong> <?php echo $model?></li>
            <?php if($transport){ ?>
            <li><i class="fa fa-car"></i> <strong><?php echo $entry_transport; ?></strong> <?php echo $transport?></li>
            <?php }?>
            <?php if($duration){ ?>
            <li><i class="fa fa-clock-o"></i> <strong><?php echo $entry_duration; ?></strong> <?php echo $duration?> <?php echo $sub_duration?></li>
            <?php }?>
            ...
            <?php }?>
            <?php if($start_time_holiday){ ?>
            <li class="start_time_tet long"><i class="fa fa-calendar-o"></i> <strong><?php echo $entry_start_time_holiday; ?></strong> <?php echo $start_time_holiday?></li>
            <?php }?>
            <?php if($not_start_time){ ?>
            <li class="not_start_time long"><i class="fa fa-calendar-o"></i> <strong><?php echo $entry_not_start_time; ?></strong> <?php echo $not_start_time?></li>
            <?php }?>
    ...
    <div id="tab-schedule" class="tab-content">
      <div class="image_promotion_date">
        <a href="javascript:void(0)" title="Tour Du Lịch Hè 2015" target="_blank"><img border="0" src="http://www.vietfuntravel.com.vn/image/data/banner-promotion/he/khuyen-mai-he-chi-tiet.jpg" alt="Tour Du Lịch Hè 2015"></a> 
      </div>
      ...
      <div class="info_details content_introduction">
        ...
        <ul>
            ...
            <ul>
                <li><span class="bluebold">Di động:</span> +84 (0) 903 550 236, +84 (0) 933 762 989</li>
            ...
            <table class="table_style table_price table_price_special">
                <tr>
                  <th rowspan="2" width="30%">Loại</th>
                    <th colspan="10" style=" border-bottom: 1px solid #ccc; ">Giá Ngày Lễ - đã giảm <br /><span>(Áp dụng từ ngày <b>18/05/2015</b> đến <b>23/08/2015</b>)</span></th>
                </tr>
                <tr>
...
var cellphonenum_dt = ["903 550 236", "933 762 989"];
shuffle(phonenum_dt);
...
function total_panel(){
  ...
  //console.log(pri_adults,pri_children,pri_single_room,pri_foreign,total_pri,total_pri_air,total);
}
$(document).ready(function() {
