...
<div id="content" class="category"><?php echo $content_top; ?>
  ...
  <div class="product-list">
  	...
  	<div>
        ...
        <div class="left">
        	<span class="text-left"><?php echo $product['model']; ?>: </span><h3 class="name"><a href="<?php echo $product['href']; ?>"><?php echo $product['name']; ?></a></h3>
            ...
            <?php if(isset($product['start_time_holiday']) && $product['start_time_holiday']){ ?><p class="start_time_tet"><?php echo $entry_start_time_holiday; ?> <span><?php echo $product['start_time_holiday']; ?></span></p><?php }?>
