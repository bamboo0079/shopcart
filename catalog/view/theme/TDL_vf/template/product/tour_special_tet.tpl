  ...
  <div class="product-info">
    ...
    <div class="left">
      ...
      <div class="button_ui" id="button-cart-dialog">
        <a href="javascript:void(0)"><span>Đặt Tour</span></a>
      </div>
    </div>
    <?php } ?>
    <div class="right">
...
<div id="cart-dialog">
    <div id="dialog">
        <div>
            ...
            <div class="left">
                <div class="step_title color1"><label>1</label><span>Loại</span></div>
                <div class="panel">
                  <label>Chọn loại khách sạn</label>
                    <select name="type_ticket_option" size="0" style="display:none">
                    <?php foreach ($options as $option)  {?>
                    ...
                    <?php foreach ($option['option_value'] as $option_value) { ?>
                    <input type="hidden" name="option[<?php echo $option['product_option_id'] ?>][<?php echo $option_value['product_option_value_id'] ?>]" value="<?php echo $option_value['price']; ?>" alt="<?php echo $option_value['price_text']; ?>" />
                    <?php }?>
                    <?php }?>
                    <?php }?>
                </div>
            ...
            <div class="right">
                <div class="step_title color2"><label>2</label><span>Số lượng khách</span></div>
                <div class="panel panel_option">
                  <div class="col_group">
                        ...
                        <?php }?>
                        </select><span id="pricehotel" style="margin-left:5px"></span>&nbsp;&nbsp;=
                    </div>
                    <div class="col_group" style="margin-top: 11%;font-size: 16px;">
                        <p id="totalpricehotel" style="color:red"></p>
                    </div>
                </div>
            </div>
...
var option_id = $('select[name="type_ticket_option"]').val();
$('select[name="type_ticket_option_value_'+option_id+'"]').change(function(event) {
  getpriceoption();
});
...
function getpriceoption(){
  var option_value = $('select[name="type_ticket_option_value_'+option_id+'"]').val();
  var price = $('input[name="'+option_value+'"]').val();
  var pricetext = $('input[name="'+option_value+'"]').attr('alt');
  var total = pricetext*$('.ticket').val();
  $('#pricehotel').html(price);
  $('#totalpricehotel').html(showNumber(String(total))+'₫');
}
</script>
