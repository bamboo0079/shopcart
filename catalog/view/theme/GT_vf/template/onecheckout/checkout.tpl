...
<div id="content"><?php echo $content_top; ?>
  ...
  <div class="slider-mid">
    ...
    <div id="confirm">
      <div class="onecheckout-heading onecheckout-confirm"><?php echo $text_checkout_confirm; ?></div>
      <div class="onecheckout-content"></div>
    </div>
  </div>
...
<link rel="stylesheet" type="text/css" href="catalog/view/theme/vf/stylesheet/onecheckout.css" media="screen" />
<style type="text/css">
<?php if ($this->config->get('onecheckout_style')==3 || !$this->config->get('onecheckout_style')) { ?>
.slider-left{width:30%;float:left;text-align:left;}
.slider-mid{width:29%;float:left;margin:0 3%;text-align:left;}
.slider-right{width:35%;float:left;text-align:left;}
<?php } elseif($this->config->get('onecheckout_style')==2) { ?>
.slider-left{width:30%;float:left;}
.slider-mid{width:66%;float:left;margin:0 0 0 3%;}
...
<?php if (!$logged) { ?>
	...
	$.ajax({
		...
		dataType: 'json',
		beforeSend: function() {
			$('#payment-address .onecheckout-content').html('<span class="wait">&nbsp;<img src="catalog/view/theme/vf/image/loading.gif" alt="" /></span>');
		},
		complete: function() {
			$('.wait').remove();
		},
	...
	$.ajax({
		...
		dataType: 'json',
		beforeSend: function() {
			$('#shipping-method .onecheckout-content').html('<span class="wait">&nbsp;<img src="catalog/view/theme/vf/image/loading.gif" alt="" /></span>');
		},
		complete: function() {
			$('.wait').remove();
		},
...
function registerorguest(){
  ...
  if($('#payment-address input[name=\'account\']:checked').attr('value')){
	$.ajax({
		...
		dataType: 'json',
		beforeSend: function() {
			$('#payment-address .onecheckout-content').append('<span class="wait">&nbsp;<img src="catalog/view/theme/vf/image/loading.gif" alt="" /></span>');
		},
		complete: function() {
			$('.wait').remove();
		},
...
function shippingaddress(){
	...
	$.ajax({
		...
		dataType: 'json',
		beforeSend: function() {
			$('#shipping-address .onecheckout-content').html('<span class="wait">&nbsp;<img src="catalog/view/theme/vf/image/loading.gif" alt="" /></span>');
		},
		complete: function() {
			$('.wait').remove();
		},
...
function paymentmethod(countryid, zoneid, isset, city, postcode) {
	$.ajax({
		...
		dataType: 'json',
		beforeSend: function() {
			$('#payment-method .onecheckout-content').html('<span class="wait">&nbsp;<img src="catalog/view/theme/vf/image/loading.gif" alt="" /></span>');
		},
		complete: function() {
			$('.wait').remove();
		},
...
//		dataType: 'TEXT',
		beforeSend: function() {
			$('#confirm .onecheckout-content').html('<span class="wait">&nbsp;<img src="catalog/view/theme/vf/image/loading.gif" alt="" /></span>');
		},
		complete: function() {
			$('.wait').remove();
		},
...
$('#button-login').live('click', function() {
	$.ajax({
		...
		beforeSend: function() {
			...
			$('#button-login').after('<span class="wait">&nbsp;<img src="catalog/view/theme/vf/image/loading.gif" alt="" /></span>');
		},
		complete: function() {
		...
		success: function(json) {
			...
			if (json['error']) {
				$('#checkout #login').after('<div class="warning" style="display: none;">' + json['error']['warning'] + '</div>');
				...
				$.ajax({
					...
					success: function(json) {
						...
						if (json['output']) {
							$('#payment-address .onecheckout-content').html(json['output']);
							$('#checkout').remove();
							$('#payment-address .onecheckout-heading').html('<?php echo $text_checkout_payment_address; ?>');
							if(json['hasshipping']){
								shippingaddresslogin();
							} else {
								paymentmethodidload($('#payment-address select[name=\'address_id\']').val());
		...
		success: function(json) {
			...
			if (json['error']) {
				...
				if (json['error']['birthday']) {
					$('#payment-address select[name=\'birthday_year\'] + br').after('<span id="error_birthday" class="error">' + json['error']['birthday'] + '</span>');
				}
	...
	$.ajax({
		...
		success: function(json) {
			...
			if (json['output']) {
				...
				$('#confirm .onecheckout-heading').html("<?php echo $text_checkout_confirm_2;?>");
				...
				$('.onecheckout-content .remove,.onecheckout-content .quantity select').hide();
				$('.onecheckout-content .quantity span').show();
...
$('#button-coupon').live('click', function() {
	$.ajax({
		...
		beforeSend: function() {
			...
			$('#button-coupon').after('<span class="wait">&nbsp;<img src="catalog/view/theme/vf/image/loading.gif" alt="" /></span>');
		},
		complete: function() {
...
$('#button-reward').live('click', function() {
	$.ajax({
		...
		beforeSend: function() {
			...
			$('#button-reward').after('<span class="wait">&nbsp;<img src="catalog/view/theme/vf/image/loading.gif" alt="" /></span>');
		},
		complete: function() {
...
$('#button-voucher').live('click', function() {
	$.ajax({
		...
		beforeSend: function() {
			...
			$('#button-voucher').after('<span class="wait">&nbsp;<img src="catalog/view/theme/vf/image/loading.gif" alt="" /></span>');
		},
		complete: function() {
...
$('#confirmorder #button-confirm').live('click', function() {
	...
	$('#confirmorder #button-confirm').after('<span class="wait">&nbsp;<img src="catalog/view/theme/vf/image/loading.gif" alt="" /></span>');
	$('#messagebox').show();
});
  ...
  $('#messagebox').hide();
	...
	$.ajax({
		...
		beforeSend: function() {
			...
			$('#button-confirmorder').after('<span class="wait">&nbsp;<img src="catalog/view/theme/vf/image/loading.gif" alt="" /></span>');
		},
		success: function(json) {
			$('.success, .warning').remove();
			...
			if (json['error']) {
				...
				//$('#payment-method').hide();
				$('html,body').animate({scrollTop: $('.slider-left').offset().top},100);
				$('#messagebox').hide();
			}
		}
	});
...
function getzone(atype,zoneid){
	...
	$.ajax({
		...
		dataType: 'json',
		beforeSend: function() {
			$('#'+atype+'-address select[name=\'country_id\']').after('<span class="wait">&nbsp;<img src="catalog/view/theme/vf/image/loading.gif" alt="" /></span>');
		},
		complete: function() {
			$('.wait').remove();
		},
