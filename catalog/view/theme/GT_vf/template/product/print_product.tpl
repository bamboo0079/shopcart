                        ...
                        <?php } ?>
                           ...
                           <td class="in" style="background: #dcedd2;">
                               ...
                               <table syle="font-size:13px">
                                   ...
                                   <tr>
                                       ...
                                       <td class="pri check_event_class" style="line-height: 1;font-weight:600;color:#004400;font-size: 14px;padding-top:16px">
                           ...
                           <td class="in" style="background: #EAEFFD;">
                               ...
                               <table>
                                   <tbody>
                                   <tr>
                                       <td class="pri check_event_class" style="line-height: 1;color:blue;font-size: 14px;font-weight:600;padding-top:16px;">
                                           <?php
                           ...
                           <td class="in" style="background: #FBF0F0;">
                               ...
                               <table>
                                   <tbody>
                                   <tr>
                                       <td class="pri check_event_class" style="line-height: 1;padding-top:16px;font-weight:600; color:blue; font-size: 14px;">
                                           <?php
                                                                        $str = str_replace(array('₫','.'),'',$option_value['price']);
                                                                        if($grouptour == 1){
                                                                            $price = (int)$str - 145000;
