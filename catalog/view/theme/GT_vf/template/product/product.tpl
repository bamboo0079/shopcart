    ...
    <meta itemprop="ratingValue" content="<?php echo $rating; ?>">
        ...
        <div class="right">
            ...
            <div class="price">
                ...
                <div class="left price_down" style="border: 0px;">
                    <span class="pont_ter"></span>
                    <p class="text_special"><i class="fa fa-gift"></i> <?php echo $text_percent; ?></span></p>
                    <label class="special"><?php echo '-'.$percent;?></label>
        ...
        <div class="introduction">
            ...
            <div id="tab-schedule" class="tab-content">
                ...
                <div class="image_promotion_date">
                    ...
                    <a href="http://www.vietfuntravel.com.vn" title="Tour Du Lịch 2/9/2015" target="_blank"><img border="0" src="<?php echo $linkbannergroup; ?>" alt="Tour Du Lịch 2015"></a>
...
<div id="tab-price" class="tab-content">
    ...
    <div class="price_details content_introduction">
        ...
        <div class="detail_tour_price_detail_wrap" id="togglerone">
            ...
            <?php if ($special && isset($grouptour) && !empty($grouptour)) { ?>

            <div class="price-detail-item">
                <div class="title_table_price title_table_price1"><span>Bảng giá khuyến mại <?php echo $promotion_title?> giổ tổ</span></div>


                <table class="table_style table_price table_price_special" style="font-family: Tahoma,Geneva,sans-serif;">
                    <tbody>
                    <tr>
                        <th colspan="5" style=" background: #006C3A; border: 1px solid #ccc "><span style="color:#C6E746">Áp dụng cho <b>NGƯỜI LỚN (09 - 99 TUỔI)</b></span></th>
                    </tr>
                    <tr>
                        <th rowspan="4" width="23%" style="background: #006C3A;color:#fff;">Loại</th>
                        <th rowspan="4" width="22%" style="background: #006C3A;font-family: Tahoma,Geneva,sans-serif; color:#fff">Giá Lễ 30/4 - 1/5 <br><b>(CHƯA GIẢM)</b></th>
                        <th colspan="20" style="border-bottom: 1px solid #ccc;background: #006C3A;font-family:Tahoma,Geneva,sans-serif;">GIÁ LỄ 40/4 - 1/5 <b>(ĐÃ GIẢM)</b></th>
                    </tr>

                    <tr >
                        <th style="background: rgba(250,207,28,0.98);color:#E10011">NHÓM < 3 khách</th>
                        <th style="background:rgba(250,207,28,0.98);color:#E10011">NHÓM 3 - 5 khách</th>
                        <th style="background: rgba(250,207,28,0.98);color:#E10011">NHÓM > 5 khách</th></tbody><tbody>
                    <tr>
                        ...
                        <td class="in" style="background: #dcedd2;">
                            ...
                            <table syle="font-size:13px">
                                ...
                                <tr>
                                    ...
                                    <td class="pri check_event_class" style="line-height: 1;font-weight:600;color:#004400; font-size:13px;padding-top:16px">
                        ...
                        <td class="in" style="background: #EAEFFD;">
                            ...
                            <table>
                                <tbody>
                                <tr>
                                    <td class="pri check_event_class" style="line-height: 1;color:blue; font-size:13px;font-weight:600;padding-top:16px;">
                                        <?php
                                                    $str = str_replace(array('₫','.'),'',$option_value['price']);
                                                    if($grouptour == 1){
                                                        $price = (int)$str - 75000;
                                                    }elseif($grouptour == 2){
                                                        $price = (int)$str - 145000;
                                                    }
                                ...
                                <tr>
                                    <td class="pri check_event_class" style="line-height: 1;color:blue;  font-size:13px;font-weight:600;padding-top:16px">
                                        <?php
                                                    $str = str_replace(array('₫','.'),'',$option_value['price']);
                                                    if($grouptour == 1){
                                                        $price = (int)$str - 105000;
                                                    }elseif($grouptour == 2){
                                                        $price = (int)$str - 175000;
                                                    }
                                                    echo $this->currency->format($price);
                                        ?><label>&nbsp;</label>
                                    </td>
                        ...
                        <td class="in" style="background: #FBF0F0;">
                            ...
                            <table>
                                <tbody>
                                <tr>
                                    <td class="pri check_event_class" style="line-height: 1;padding-top:16px;font-weight:600; color:blue">
                                        <?php
                                                    $str = str_replace(array('₫','.'),'',$option_value['price']);
                                                    if($grouptour == 1){
                                                        $price = (int)$str - 145000;
                                                    }elseif($grouptour == 2){
                                                        $price = (int)$str - 295000;
                                                    }
                                                    echo $this->currency->format($price);
                                        ?><label>&nbsp;</label>
                                    </td>
            ...
            <?php if (isset($special2)) { ?>



            <div class="price-detail-item">

                <div class="title_table_price title_table_price1"><span>Bảng giá khuyến mại <?php echo $promotion_title?></span></div>

                <table class="table_style table_price table_price_special">

                    <tr>

                        <th rowspan="2" width="30%">Loại</th>

                        <th colspan="10" style=" border-bottom: 1px solid #ccc; ">Giá Ngày Lễ - đã giảm <br /><span>(Áp dụng từ ngày <b>01/06/2015</b> đến <b>23/08/2015</b>)</span></th>
            ...
            <div class="price-detail-item">
                ...
                <div class="title_table_price">
                    <?php if($grouptour == 4) { ?>
                    <span>Bảng giá ngày Tết </span>
                    <?php }  else { ?>
                    <span>Bảng giá ngày thường </span>
                    <?php } ?>
                </div>
...
<?php if(preg_match('/Phụ thu phòng đơn/', $option['name'])){ $check_single_room = true;} ?>

<?php if(preg_match('/Phụ thu ngoại quốc/', $option['name'])){ $check_foreign = true;} ?>
        ...
        <div>
            ...
            <div class="content">
                ...
                <div class="cart-dialog-content">
                    ...
                    <?php /* Nhut sua update loai ngay 24/11 - Minh update code vao 23/12 */?>
                    <script>
                        $(function(){
                            $('body').delegate('.ui-state-default','click',function(){
                                ...
                                <?php foreach ($options as $option)  { ?>
                                    <?php if ($option['type'] == 'checkbox' && $option['category'] == '1' && $option['class'] == '0') { ?>
                                        <?php $count = 1;?>
                                        <?php foreach ($option['option_value'] as $option_value) { ?>
                                                html += '<option value="<?php echo $count; ?>"><?php echo $option_value["name"]; ?></option>';
                                            <?php $count++;}?>
                                        <?php break; } ?>
                                    <?php } ?>
                    ...
                    <?php /* end sua update loai ngay 24/11 - Minh update code vao 23/12 */ ?>

                    <div class="clear"></div>

                    <?php /* hidden chua loai nhom */?>

                    <input type="hidden" name="daypayment" class="daypayment" value="<?php echo (isset($grouptour) ? $grouptour : '');?>">

                    <?php /* end hidden chua loai nhom */?>

                    <?php /*<div class="right row2" style="display:none" id="daypayment">
                    <div class="step_title color3" style="padding-right:28px"><label>3</label><span>Thanh Toán</span></div>
                    <div class="panel">
                        <input type="radio" name="daypayment" value="1" checked />Trước 1 ngày
                        <input type="radio" name="daypayment" value="2" />Trước 4 ngày
                        <input type="radio" name="daypayment" value="3" />Trước 7 ngày
                    </div>
                </div> */ ?>
                <input type="hidden" name="dayment" id="dayment" value="" />
...
<div id="choose-tour">
    <div class="normal">
        ...
        <?php foreach ($options as $option) { ?>
        <?php $nangcapks = array('84','99','109','119'); ?>
        <?php if ($option['type'] == 'checkbox' && $option['category'] == '0' && $option['class'] == '0' && in_array($option['option_id'],$nangcapks) == false) { ?>
    ...
    <div class="holy1">
        ...
        <?php foreach ($options as $option) { ?>
        <?php $nangcapks = array('84','99','109','119'); ?>
        <?php if ($option['type'] == 'checkbox' && $option['category'] == '1' && $option['class'] == '0' && in_array($option['option_id'],$nangcapks) == false) { ?>
...
<script type="text/javascript"><!--
    ...
    $('#button-cart').bind('click', function() {
        ...
        $.ajax({
            ...
            data: $('.cart-dialog-content input[type=\'text\'], .cart-dialog-content input[type=\'hidden\'], .cart-dialog-content input[type=\'radio\']:checked, .cart-dialog-content input[type=\'checkbox\']:checked, .cart-dialog-content select, .cart-dialog-content textarea,#dayment'),
...
//    var product_id = $('input[name=product_id]').val();
    ...
    if(date_ch >= Date.parse('<?php echo $promotion_date_start2; ?>') && date_ch <= Date.parse('<?php echo $promotion_date_end; ?>')){
        $('#daypayment').attr('style', 'display:block');
        var daypayment = parseInt($('.daypayment').val());
        $('#dayment').val(daypayment);
        var grouptour = <?php echo $grouptour ?>;
        var count_adult = parseInt($('.adults').val());
        if(checkevent){
            if(daypayment == 1){
                if(count_adult < 3){
                    var value_down = 75000;
                }
                if(count_adult >= 3 && adults < 5){
                    var value_down = 105000;
                }
                if(count_adult > 5){
                    var value_down = 145000;
                }
            }
            if(daypayment == 2){
                if(count_adult < 3){
                ...
                if(count_adult >= 3 && count_adult <= 5){
                    var value_down = 175000;
                }
                if(count_adult > 5){
                    var value_down = 295000;
                }
            }
            ...
            html_down += '<td style="text-align:left"><strong> '+ showNumber(String(adults.find(":selected").val() * value_down))+ '₫' + '</strong></td>';
            html_down += '</tr>';
            html_down += '<tr style="line-height: 20px">';
        ...
        $('#daypayment').attr('style', 'display:none');
        $('#dayment').val(0);
...
$(document).ready(function() {
    ...
    $('input[name="daypayment"]').bind('click',function(){
        total_panel();
    });
