...
<div id="footer">
  <div id="footer_left">
    ...
    <ul class="footer_list">
      ...
      <li><span class="bold"><?php echo $text_copy?></span><h2><a href="<?php echo $home?>" title="Tour Du Lịch Việt Nam 2016 - Viet Fun Travel - Du Lịch Việt Vui" target="_blank">-<?php echo $text_copy2 ?></a></h2></li>
    </ul>
  </div>
...
<div class="phone_contact">
   <?php /*  <div class="tv">
    ...
    <img src="<?php echo $image_support_footer;?>" alt="Vietfuntravel support" title="Vietfuntravel support">
</div>
