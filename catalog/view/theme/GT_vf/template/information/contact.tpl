  ...
  <div class="ct-left">
    ...
    <table>
      ...
      <tr>
        ...
        <?php /* <td>+84 (0) 903 550 236 | +84 (0) 903 779 759</td> */?>
        <td>+84 (08) 2210 2465 - 2240 6474 - 6651 81 67</td>
      </tr>
      <tr>
    ...
    <h1 class="h1-footer">Liên kết với Viet Fun Travel</h1>
    <div class="ct-line"><img src="<?php echo $line; ?>"></div>
    <table class="icon-lg">
      <tr>
        ...
        <?php /* <td><img src="<?php echo $pr_icon;?>"></td>
