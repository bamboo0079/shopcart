...
class ControllerAccountRegister extends Controller {
	...
	public function index() {
		...
		$this->data['text_placeholder_address'] = $this->language->get('text_placeholder_address');
		...
		$this->data['lang_error_birthday'] = $this->language->get('error_birthday');
		$this->data['lang_error_email'] = $this->language->get('error_email');
		$this->data['lang_error_telephone'] = $this->language->get('error_telephone');
		$this->data['lang_error_password'] = $this->language->get('error_password');
		$this->data['lang_error_confirm'] = $this->language->get('error_confirm');
		$this->data['lang_error_address'] = $this->language->get('error_address');
		$this->data['lang_error_country'] = $this->language->get('error_country');
		$this->data['lang_error_zone'] = $this->language->get('error_zone');
		...
		$this->data['lang_error_agree'] = $this->language->get('error_agree');
		...
		if (isset($this->request->post['password_confirmation'])) {
			$this->data['password_confirmation'] = $this->request->post['password_confirmation'];
		} else {
	...
	protected function validate() {
		...
		if ((utf8_strlen($this->request->post['address_1']) < 1) || (utf8_strlen($this->request->post['address_1']) > 255)) {
		...
		if ($this->request->post['password_confirmation'] != $this->request->post['password']) {
