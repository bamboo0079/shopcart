<?php
    class ControllerEventEvent extends Controller{
        ...
        public function index(){
            ...
            $this->data['link_add'] = $this->url->link('event/event/add_new','token='.$this->session->data['token'],'SSL');
            ...
            $this->data['breadcrumbs'][] = array(
                ...
                'href'      => $this->url->link('event/event', 'token=' . $this->session->data['token'], 'SSL'),
                'separator' => ' :: '
            );
            ...
            if(!empty($event_list)){
                ...
                for($i = 0; $i < count($event_list); $i++){
                    if(isset($event_list[$i]['edit_link'])) {
                        $event_list[$i]['edit_link'] = $this->url->link('event/event/event_edit&id=' . $event_list[$i]['event_id'] . '', 'token=' . $this->session->data['token'], 'SSL');
                        $event_list[$i]['delete_link'] = $this->url->link('event/event/event_delete&id=' . $event_list[$i]['event_id'] . '', 'token=' . $this->session->data['token'], 'SSL');
                    }
                }
            }
            $this->data['event_list'] =  $event_list;
            $this->data['action_form'] = $this->url->link('event/event/delete_event','token='.$this->session->data['token'],'SSL');
...
//            print_r($data['action']);exit;
        ...
        public function edit_event(){
            ...
            $this->data['cancel'] = $this->url->link('event/event', 'token=' . $this->session->data['token'], 'SSL');

            $this->data['action'] = $this->url->link('event/event/processevent','token='.$this->session->data['token'],'SSL');
...
//                    exit;
                ...
                $this->redirect($this->url->link('event/event/add_new', 'token=' . $this->session->data['token'], 'SSL'));
            }
