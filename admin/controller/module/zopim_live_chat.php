...
class ControllerModuleZopimLiveChat extends Controller {
	...
	public function index() {   
		...
		if (isset($this->request->post['zopim_live_chat_code'])) {
			$this->data['zopim_live_chat_code'] = $this->request->post['zopim_live_chat_code'];
		} else {
			$this->data['zopim_live_chat_code'] = $this->config->get('zopim_live_chat_code');
		}	
	...
	protected function validate() {
		...
		if (!$this->request->post['zopim_live_chat_code']) {
