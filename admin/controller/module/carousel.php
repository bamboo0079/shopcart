...
class ControllerModuleCarousel extends Controller {
	...
	public function index() {   
		...
		//carousel_product
		if (isset($this->request->post['carousel_product'])) {
			$this->data['carousel_product'] = $this->request->post['carousel_product'];
			$products = explode(',', $this->request->post['carousel_product']);
		} else {		
			$this->data['carousel_product'] = $this->config->get('carousel_product');
			$products = explode(',', $this->config->get('carousel_product'));
		}
