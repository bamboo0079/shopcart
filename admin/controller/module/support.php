...
class ControllerModuleSupport extends Controller {
	...
	public function index() {   
		...
		$this->data['action'] = $this->url->link('module/support', 'token=' . $this->session->data['token'], 'SSL');

		$this->data['cancel'] = $this->url->link('extension/module', 'token=' . $this->session->data['token'], 'SSL');

		$this->data['modules'] = array();

		if (isset($this->request->post['support_module'])) {
			$this->data['modules'] = $this->request->post['support_module'];
		} elseif ($this->config->get('support_module')) { 
			$this->data['modules'] = $this->config->get('support_module');
		}	
