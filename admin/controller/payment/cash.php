...
class ControllerPaymentCash extends Controller {
	...
	public function index() {
		...
		foreach ($languages as $language) {
			if (isset($this->request->post['cash_bank_' . $language['language_id']])) {
				$this->data['cash_bank_' . $language['language_id']] = $this->request->post['cash_bank_' . $language['language_id']];
			} else {
				$this->data['cash_bank_' . $language['language_id']] = $this->config->get('cash_bank_' . $language['language_id']);
			}
		}
		...
		if (isset($this->request->post['cash_geo_zone_id'])) {
			$this->data['cash_geo_zone_id'] = $this->request->post['cash_geo_zone_id'];
		} else {
			$this->data['cash_geo_zone_id'] = $this->config->get('cash_geo_zone_id'); 
		} 
	...
	protected function validate() {
		...
		foreach ($languages as $language) {
			if (!$this->request->post['cash_bank_' . $language['language_id']]) {
