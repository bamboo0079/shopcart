...
class ControllerDesignBanner extends Controller {
	...
	public function update() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->model_design_banner->editBanner($this->request->get['banner_id'],$language_id, $this->request->post);
	...
	protected function getForm() {
        ...
        $this->data['oder'] = $this->language->get('oder');
...
//        print_r($banner_images);exit;
		...
		foreach ($banner_images as $banner_image) {
			...
			$this->data['banner_images'][] = array(
                ...
                'oder'                    => isset($banner_image['oder']) ? $banner_image['oder'] : 1,
			);
		}
