...
class ControllerUserUser extends Controller {
	...
	protected function getForm() {
		...
		$this->data['entry_name_display'] = $this->language->get('entry_name_display');
		...
		if (isset($this->request->post['name_display'])) {
      		$this->data['name_display'] = $this->request->post['name_display'];
    	} elseif (!empty($user_info)) {
			$this->data['name_display'] = $user_info['name_display'];
		} else {
      		$this->data['name_display'] = '';
    	}
