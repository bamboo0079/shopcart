                    ...
                    <tbody>
                        ...
                        <tr>
                            <td style="text-align: center;">
                                <?php if ($policy['selected']) { ?>
                                <input type="checkbox" name="selected[]" value="<?php echo $policy['policy_id']; ?>" checked="checked" />
                                <?php } else { ?>
                                <input type="checkbox" name="selected[]" value="<?php echo $policy['policy_id']; ?>" />
                                <?php } ?>
                            </td>
                            <td class="left">
                            ...
                            <td class="right">
                                ...
                                <?php if($k == $policy['category']){?>
                                <?php echo $v?>
                                <?php }?>
                                <?php }?>
                            </td>
                            <td class="right">
                                <?php echo $policy[ 'sort_order']; ?>
                            </td>
                            <td class="right">
                                <?php echo $policy[ 'status']; ?>
                            </td>
                            <td class="right">
                                <?php foreach ($policy[ 'action'] as $action) { ?>[
