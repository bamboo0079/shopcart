        ...
        <table class="list">
          <thead>
            <tr>
              ...
              <td class="left" style="width:200px"><?php if ($sort == 'nd.name') { ?>
                <a href="<?php echo $sort_name; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_name; ?></a>
                <?php } else { ?>
                <a href="<?php echo $sort_name; ?>"><?php echo $column_name; ?></a>
                <?php } ?></td>
              <td class="left"><?php echo $column_yahoo; ?></td>
              <td class="left"><?php echo $column_skype; ?></td>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="left"><?php echo $item['yahoo']; ?></td>
              <td class="left"><?php echo $item['skype']; ?></td>
