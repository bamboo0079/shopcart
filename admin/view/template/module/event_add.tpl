    ...
    <div class="box">
        ...
        <div class="content">
            <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
                ...
                <table class="form">
                    <tr>
                        <td><?php echo $event_name_title;?>:</td>
                        <td>
                            <table>
                                <tr>
                    ...
                    ?>
                    <tr>
                        <td><input type="text" data-rule-required="true" data-msg-required="* Vui lòng nhập tên nhóm" name="group_name[]" placeholder="Loại tour" class="group_name" value="<?php echo $product['name']?>"><input type="hidden" name="event_attr[]" value="<?php echo $product['name'];?>">:</td>
                        <td><input class="mntal_product" type="text" name="mntal_product" value="" size="100"/>   <img class="add_group" src="view/image/add.png"></td>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
                        <td>
                    ...
                    <tr>
                        <td>Name:</td>
                        <td><input type="text" name="khtetamlich_title" data-rule-required="true" data-msg-required="* Vui lòng nhập tên" value="<?php echo (isset($event_description[0]['customertitle']) ? $event_description[0]['customertitle'] : '');?>" size="100"/></td>
                    </tr>
                    <tr>
                        <td>Meta Keyword:</td>
...
<script type="text/javascript">
    $(function(){
        ...
        $('body').delegate('.add_group','click',function(){
            ...
            html += '<td><input type="text" name="mntal_product[]" value="" size="100" class="ui-autocomplete-input mntal_product" autocomplete="off" role="textbox" aria-autocomplete="list" aria-haspopup="true">   <img class="add_group" src="view/image/add.png"></td>';
            html += '</tr>';
            html += '<tr>';
            html += '<td>&nbsp;</td>';
            html += '<td>';
