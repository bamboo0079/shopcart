      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <table class="form">
          <tr>
            ...
            <td><input type="text" name="msg1nevendl_product" value="" size="100"/></td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td><div id="khmsg1nhe-product" class="scrollbox" style="width:80%">
                <?php $class = 'odd'; ?>
                <?php $cn = 1;?>
                <?php foreach ($khmsg1nevendl_product_box as $product) { ?>
              ...
              <input type="hidden" name="khmsg1nevendl_product" value="<?php echo $khmsg1nevendl_product; ?>" /></td>
          </tr>
        <tr>
            <td>SÀI GÒN TOUR 3 - 4 - 5 NGÀY:</td>
            <td><input type="text" name="msg3nevendl_product" value=""size="100" /></td>
        </tr>
        <tr>
            <td>&nbsp;</td>
            <td><div id="khmsg3nhe-product" class="scrollbox" style="width:80%">
                <?php $class = 'odd'; ?>
                <?php $ct = 1;?>
                <?php foreach ($khmsg3nevendl_product_box as $product) { ?>
                <?php $class = ($class == 'even' ? 'odd' : 'even'); ?>
              ...
              <input type="hidden" name="khmsg3nevendl_product" value="<?php echo $khmsg3nevendl_product; ?>" /></td>
        </tr>
        <tr>
            <td>SÀI GÒN TOUR 6 NGÀY TRỞ LÊN:</td>
            <td><input type="text" name="msg6nevendl_product" value=""size="100" /></td>
        </tr>
        <tr>
            <td>&nbsp;</td>
            <td>
                <div id="khmsg6nhe-product" class="scrollbox" style="width:80%">
                    <?php $class = 'odd'; ?>
                    <?php $ct = 1;?>
                    <?php foreach ($khmsg6nevendl_product_box as $product) { ?>
                    <?php $class = ($class == 'even' ? 'odd' : 'even'); ?>
                ...
                <input type="hidden" name="khmsg6nevendl_product" value="<?php echo $khmsg6nevendl_product; ?>" />
            </td>
        </tr>
<!-- MT -->
        <tr>
            <td>MIEN TAY TOUR 1 -2 NGÀY:</td>
            <td><input type="text" name="mmt1nevendl_product" value="" size="100"/></td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td><div id="khmmt1nhe-product" class="scrollbox" style="width:80%">
                <?php $class = 'odd'; ?>
                <?php $cn = 1;?>
                <?php foreach ($khmmt1nevendl_product_box as $product) { ?>
                <?php $class = ($class == 'even' ? 'odd' : 'even'); ?>
              ...
              <input type="hidden" name="khmmt1nevendl_product" value="<?php echo $khmmt1nevendl_product; ?>" /></td>
          </tr>
        <tr>
            <td>MIEN TAY TOUR 3 - 4 - 5 NGÀY:</td>
            <td><input type="text" name="mmt3nevendl_product" value=""size="100" /></td>
        </tr>
        <tr>
            <td>&nbsp;</td>
            <td><div id="khmmt3nhe-product" class="scrollbox" style="width:80%">
                <?php $class = 'odd'; ?>
                <?php $ct = 1;?>
                <?php foreach ($khmmt3nevendl_product_box as $product) { ?>
                <?php $class = ($class == 'even' ? 'odd' : 'even'); ?>
              ...
              <input type="hidden" name="khmmt3nevendl_product" value="<?php echo $khmmt3nevendl_product; ?>" /></td>
        </tr>
        <tr>
            <td>MIEN TAY TOUR 6 NGÀY TRỞ LÊN:</td>
            <td><input type="text" name="mmt6nevendl_product" value=""size="100" /></td>
        </tr>
        <tr>
            <td>&nbsp;</td>
            <td>
                <div id="khmmt6nhe-product" class="scrollbox" style="width:80%">
                    <?php $class = 'odd'; ?>
                    <?php $ct = 1;?>
                    <?php foreach ($khmmt6nevendl_product_box as $product) { ?>
                    <?php $class = ($class == 'even' ? 'odd' : 'even'); ?>
                ...
                <input type="hidden" name="khmmt6nevendl_product" value="<?php echo $khmmt6nevendl_product; ?>" />
            </td>
        </tr>
<!-- VT start -->
        <tr>
            <td>VŨNG TÀU TOUR 1 -2 NGÀY:</td>
            <td><input type="text" name="mvt1nevendl_product" value="" size="100"/></td>
        </tr>
        <tr>
            <td>&nbsp;</td>
            <td>
                <div id="khmvt1nhe-product" class="scrollbox" style="width:80%">
                    <?php $class = 'odd'; ?>
                    <?php $cn = 1;?>
                    <?php foreach ($khmvt1nevendl_product_box as $product) { ?>
                    <?php $class = ($class == 'even' ? 'odd' : 'even'); ?>
                ...
                <input type="hidden" name="khmvt1nevendl_product" value="<?php echo $khmvt1nevendl_product; ?>" />
            </td>
        </tr>
        <tr>
            <td>VŨNG TÀU TOUR 3 - 4 - 5 NGÀY:</td>
            <td><input type="text" name="mvt3nevendl_product" value=""size="100" /></td>
        </tr>
        <tr>
            <td>&nbsp;</td>
            <td><div id="khmvt3nhe-product" class="scrollbox" style="width:80%">
                <?php $class = 'odd'; ?>
                <?php $ct = 1;?>
                <?php foreach ($khmvt3nevendl_product_box as $product) { ?>
                <?php $class = ($class == 'even' ? 'odd' : 'even'); ?>
              ...
              <input type="hidden" name="khmvt3nevendl_product" value="<?php echo $khmvt3nevendl_product; ?>" /></td>
        </tr>
        <tr>
            <td>VŨNG TÀU TOUR 6 NGÀY TRỞ LÊN:</td>
            <td><input type="text" name="mvt6nevendl_product" value=""size="100" /></td>
        </tr>
        <tr>
            <td>&nbsp;</td>
            <td>
                <div id="khmvt6nhe-product" class="scrollbox" style="width:80%">
                    <?php $class = 'odd'; ?>
                    <?php $ct = 1;?>
                    <?php foreach ($khmvt6nevendl_product_box as $product) { ?>
                    <?php $class = ($class == 'even' ? 'odd' : 'even'); ?>
                ...
                <input type="hidden" name="khmvt6nevendl_product" value="<?php echo $khmvt6nevendl_product; ?>" />
            </td>
        </tr>
        <tr>
            <td>PHÚ QUỐC 1 - 2 NGÀY:</td>
            <td><input type="text" name="mpq1nevendl_product" value="" size="100"/></td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td><div id="khmpq1nhe-product" class="scrollbox" style="width:80%">
                <?php $class = 'odd'; ?>
                <?php $cb = 1;?>
                <?php foreach ($khmpq1nevendl_product_box as $product) { ?>
                <?php $class = ($class == 'even' ? 'odd' : 'even'); ?>
              ...
              <input type="hidden" name="khmpq1nevendl_product" value="<?php echo $khmpq1nevendl_product; ?>" /></td>
          </tr>
          <tr>
            <td>PHÚ QUỐC 3-4-5 NGÀY:</td>
            <td><input type="text" name="mpq3nevendl_product" value="" size="100"/></td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td><div id="khmpq3nhe-product" class="scrollbox" style="width:80%">
                <?php $class = 'odd'; ?>
                <?php $cb = 1;?>
                <?php foreach ($khmpq3nevendl_product_box as $product) { ?>
                <?php $class = ($class == 'even' ? 'odd' : 'even'); ?>
              ...
              <input type="hidden" name="khmpq3nevendl_product" value="<?php echo $khmpq3nevendl_product; ?>" /></td>
          </tr>
          <tr>
            <td>PHÚ QUỐC 6 NGÀY TRỞ LÊN:</td>
            <td><input type="text" name="mpq6nevendl_product" value="" size="100"/></td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td><div id="khmpq6nhe-product" class="scrollbox" style="width:80%">
                <?php $class = 'odd'; ?>
                <?php $cb = 1;?>
                <?php foreach ($khmpq6nevendl_product_box as $product) { ?>
                <?php $class = ($class == 'even' ? 'odd' : 'even'); ?>
              ...
              <input type="hidden" name="khmpq6nevendl_product" value="<?php echo $khmpq6nevendl_product; ?>" /></td>
          </tr>
<!-- PT start -->
        <tr>
            <td>PHAN THIẾT 1 - 2 NGÀY:</td>
            <td><input type="text" name="mpt1nevendl_product" value="" size="100"/></td>
        </tr>
        <tr>
            <td>&nbsp;</td>
            <td><div id="khmpt1nhe-product" class="scrollbox" style="width:80%">
                <?php $class = 'odd'; ?>
                <?php $cb = 1;?>
                <?php foreach ($khmpt1nevendl_product_box as $product) { ?>
                <?php $class = ($class == 'even' ? 'odd' : 'even'); ?>
              ...
              <input type="hidden" name="khmpt1nevendl_product" value="<?php echo $khmpt1nevendl_product; ?>" /></td>
          </tr>
          <tr>
            <td>PHAN THIẾT 3 - 4 - 5 NGÀY:</td>
            <td><input type="text" name="mpt3nevendl_product" value="" size="100"/></td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td><div id="khmpt3nhe-product" class="scrollbox" style="width:80%">
                <?php $class = 'odd'; ?>
                <?php $cb = 1;?>
                <?php foreach ($khmpt3nevendl_product_box as $product) { ?>
                <?php $class = ($class == 'even' ? 'odd' : 'even'); ?>
              ...
              <input type="hidden" name="khmpt3nevendl_product" value="<?php echo $khmpt3nevendl_product; ?>" /></td>
          </tr>
        <tr>
            <td>PHAN THIẾT 6 TRỞ LÊN:</td>
            <td><input type="text" name="mpt6nevendl_product" value="" size="100"/></td>
        </tr>
        <tr>
            <td>&nbsp;</td>
            <td>
                ...
                <?php $class = 'odd'; ?>
                <?php $cb = 1;?>
                <?php foreach ($khmpt6nevendl_product_box as $product) { ?>
                <?php $class = ($class == 'even' ? 'odd' : 'even'); ?>
              ...
              <input type="hidden" name="khmpt6nevendl_product" value="<?php echo $khmpt6nevendl_product; ?>" /></td>
        </tr>

        <tr>
            <td>DÀ LẠT 1 - 2 NGÀY:</td>
            <td><input type="text" name="mdl1nevendl_product" value="" size="100"/></td>
        </tr>
        <tr>
            <td>&nbsp;</td>
            <td><div id="khmdl1nhe-product" class="scrollbox" style="width:80%">
                <?php $class = 'odd'; ?>
                <?php $cb = 1;?>
                <?php foreach ($khmdl1nevendl_product_box as $product) { ?>
                <?php $class = ($class == 'even' ? 'odd' : 'even'); ?>
              ...
              <input type="hidden" name="khmdl1nevendl_product" value="<?php echo $khmdl1nevendl_product; ?>" /></td>
          </tr>
          <tr>
            <td>ĐÀ LẠT 3 - 4 - 5 NGÀY:</td>
            <td><input type="text" name="mdl3nevendl_product" value="" size="100"/></td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td><div id="khmdl3nhe-product" class="scrollbox" style="width:80%">
                <?php $class = 'odd'; ?>
                <?php $cb = 1;?>
                <?php foreach ($khmdl3nevendl_product_box as $product) { ?>
                <?php $class = ($class == 'even' ? 'odd' : 'even'); ?>
              ...
              <input type="hidden" name="khmdl3nevendl_product" value="<?php echo $khmdl3nevendl_product; ?>" /></td>
          </tr>
        <tr>
            <td>ĐÀ LẠT 6 TRỞ LÊN:</td>
            <td><input type="text" name="mdl6nevendl_product" value="" size="100"/></td>
        </tr>
        <tr>
            <td>&nbsp;</td>
            <td>
                ...
                <?php $class = 'odd'; ?>
                <?php $cb = 1;?>
                <?php foreach ($khmdl6nevendl_product_box as $product) { ?>
                <?php $class = ($class == 'even' ? 'odd' : 'even'); ?>
              ...
              <input type="hidden" name="khmdl6nevendl_product" value="<?php echo $khmdl6nevendl_product; ?>" /></td>
        </tr>
        <tr>
            <td>NHA TRANG 1 - 2 NGÀY:</td>
            <td><input type="text" name="mnt1nevendl_product" value="" size="100"/></td>
        </tr>
        <tr>
            <td>&nbsp;</td>
            <td><div id="khmnt1nhe-product" class="scrollbox" style="width:80%">
                <?php $class = 'odd'; ?>
                <?php $cb = 1;?>
                <?php foreach ($khmnt1nevendl_product_box as $product) { ?>
                <?php $class = ($class == 'even' ? 'odd' : 'even'); ?>
              ...
              <input type="hidden" name="khmnt1nevendl_product" value="<?php echo $khmnt1nevendl_product; ?>" /></td>
          </tr>
          <tr>
            <td>NHA TRANG 3 - 4 - 5 NGÀY:</td>
            <td><input type="text" name="mnt3nevendl_product" value="" size="100"/></td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td><div id="khmnt3nhe-product" class="scrollbox" style="width:80%">
                <?php $class = 'odd'; ?>
                <?php $cb = 1;?>
                <?php foreach ($khmnt3nevendl_product_box as $product) { ?>
                <?php $class = ($class == 'even' ? 'odd' : 'even'); ?>
              ...
              <input type="hidden" name="khmnt3nevendl_product" value="<?php echo $khmnt3nevendl_product; ?>" /></td>
          </tr>
        <tr>
            <td>NHA TRANG 6 TRỞ LÊN:</td>
            <td><input type="text" name="mnt6nevendl_product" value="" size="100"/></td>
        </tr>
        <tr>
            <td>&nbsp;</td>
            <td>
                ...
                <?php $class = 'odd'; ?>
                <?php $cb = 1;?>
                <?php foreach ($khmnt6nevendl_product_box as $product) { ?>
                <?php $class = ($class == 'even' ? 'odd' : 'even'); ?>
              ...
              <input type="hidden" name="khmnt6nevendl_product" value="<?php echo $khmnt6nevendl_product; ?>" /></td>
        </tr>
        <tr>
            <td>ĐÀ NẴNG 1 -2 NGÀY:</td>
            <td><input type="text" name="mdn1nevendl_product" value="" size="100"/></td>
        </tr>
        <tr>
            <td>&nbsp;</td>
            <td><div id="khmdn1nhe-product" class="scrollbox" style="width:80%">
                <?php $class = 'odd'; ?>
                <?php $cb = 1;?>
                <?php foreach ($khmdn1nevendl_product_box as $product) { ?>
                <?php $class = ($class == 'even' ? 'odd' : 'even'); ?>
              ...
              <input type="hidden" name="khmdn1nevendl_product" value="<?php echo $khmdn1nevendl_product; ?>" /></td>
        </tr>
        <tr>
            <td>ĐÀ NẴNG 3-4-5 NGÀY:</td>
            <td><input type="text" name="mdn3nevendl_product" value="" size="100"/></td>
        </tr>
        <tr>
            <td>&nbsp;</td>
            <td><div id="khmdn3nhe-product" class="scrollbox" style="width:80%">
                <?php $class = 'odd'; ?>
                <?php $cb = 1;?>
                <?php foreach ($khmdn3nevendl_product_box as $product) { ?>
                <?php $class = ($class == 'even' ? 'odd' : 'even'); ?>
              ...
              <input type="hidden" name="khmdn3nevendl_product" value="<?php echo $khmdn3nevendl_product; ?>" /></td>
        </tr>
        <tr>
            <td>ĐÀ NẴNG 6 NGÀY TRỞ LÊN:</td>
            <td><input type="text" name="mdn6nevendl_product" value="" size="100"/></td>
        </tr>
        <tr>
            <td>&nbsp;</td>
            <td><div id="khmdn6nhe-product" class="scrollbox" style="width:80%">
                <?php $class = 'odd'; ?>
                <?php $cb = 1;?>
                <?php foreach ($khmdn6nevendl_product_box as $product) { ?>
                <?php $class = ($class == 'even' ? 'odd' : 'even'); ?>
              ...
              <input type="hidden" name="khmdn6nevendl_product" value="<?php echo $khmdn6nevendl_product; ?>" /></td>
        </tr>
        <tr>
            <td>HỘI AN 1 -2 NGÀY:</td>
            <td><input type="text" name="mha1nevendl_product" value="" size="100"/></td>
        </tr>
        <tr>
            <td>&nbsp;</td>
            <td><div id="khmha1nhe-product" class="scrollbox" style="width:80%">
                <?php $class = 'odd'; ?>
                <?php $cb = 1;?>
                <?php foreach ($khmha1nevendl_product_box as $product) { ?>
                <?php $class = ($class == 'even' ? 'odd' : 'even'); ?>
              ...
              <input type="hidden" name="khmha1nevendl_product" value="<?php echo $khmha1nevendl_product; ?>" /></td>
        </tr>
        <tr>
            <td>HỘI AN 3-4-5 NGÀY:</td>
            <td><input type="text" name="mha3nevendl_product" value="" size="100"/></td>
        </tr>
        <tr>
            <td>&nbsp;</td>
            <td><div id="khmha3nhe-product" class="scrollbox" style="width:80%">
                <?php $class = 'odd'; ?>
                <?php $cb = 1;?>
                <?php foreach ($khmha3nevendl_product_box as $product) { ?>
                <?php $class = ($class == 'even' ? 'odd' : 'even'); ?>
              ...
              <input type="hidden" name="khmha3nevendl_product" value="<?php echo $khmha3nevendl_product; ?>" /></td>
        </tr>
        <tr>
            <td>HỘI AN 6 NGÀY TRỞ LÊN:</td>
            <td><input type="text" name="mha6nevendl_product" value="" size="100"/></td>
        </tr>
        <tr>
            <td>&nbsp;</td>
            <td><div id="khmha6nhe-product" class="scrollbox" style="width:80%">
                <?php $class = 'odd'; ?>
                <?php $cb = 1;?>
                <?php foreach ($khmha6nevendl_product_box as $product) { ?>
                <?php $class = ($class == 'even' ? 'odd' : 'even'); ?>
              ...
              <input type="hidden" name="khmha6nevendl_product" value="<?php echo $khmha6nevendl_product; ?>" /></td>
        </tr>
        <tr>
            <td>HUẾ 1 -2 NGÀY:</td>
            <td><input type="text" name="mhue1nevendl_product" value="" size="100"/></td>
        </tr>
        <tr>
            <td>&nbsp;</td>
            <td><div id="khmhue1nhe-product" class="scrollbox" style="width:80%">
                <?php $class = 'odd'; ?>
                <?php $cb = 1;?>
                <?php foreach ($khmhue1nevendl_product_box as $product) { ?>
                <?php $class = ($class == 'even' ? 'odd' : 'even'); ?>
              ...
              <input type="hidden" name="khmhue1nevendl_product" value="<?php echo $khmhue1nevendl_product; ?>" /></td>
        </tr>
        <tr>
            <td>HUẾ 3-4-5 NGÀY:</td>
            <td><input type="text" name="mhue3nevendl_product" value="" size="100"/></td>
        </tr>
        <tr>
            <td>&nbsp;</td>
            <td><div id="khmhue3nhe-product" class="scrollbox" style="width:80%">
                <?php $class = 'odd'; ?>
                <?php $cb = 1;?>
                <?php foreach ($khmhue3nevendl_product_box as $product) { ?>
                <?php $class = ($class == 'even' ? 'odd' : 'even'); ?>
              ...
              <input type="hidden" name="khmhue3nevendl_product" value="<?php echo $khmhue3nevendl_product; ?>" /></td>
        </tr>
        <tr>
            <td>HUẾ 6 NGÀY TRỞ LÊN:</td>
            <td><input type="text" name="mhue6nevendl_product" value="" size="100"/></td>
        </tr>
        <tr>
            <td>&nbsp;</td>
            <td><div id="khmhue6nhe-product" class="scrollbox" style="width:80%">
                <?php $class = 'odd'; ?>
                <?php $cb = 1;?>
                <?php foreach ($khmhue6nevendl_product_box as $product) { ?>
                <?php $class = ($class == 'even' ? 'odd' : 'even'); ?>
              ...
              <input type="hidden" name="khmhue6nevendl_product" value="<?php echo $khmhue6nevendl_product; ?>" /></td>
        </tr>
        <tr>
            <td>HÀ NỘI 1 -2 NGÀY:</td>
            <td><input type="text" name="mhn1nevendl_product" value="" size="100"/></td>
        </tr>
        <tr>
            <td>&nbsp;</td>
            <td><div id="khmhn1nhe-product" class="scrollbox" style="width:80%">
                <?php $class = 'odd'; ?>
                <?php $cb = 1;?>
                <?php foreach ($khmhn1nevendl_product_box as $product) { ?>
                <?php $class = ($class == 'even' ? 'odd' : 'even'); ?>
              ...
              <input type="hidden" name="khmhn1nevendl_product" value="<?php echo $khmhn1nevendl_product; ?>" /></td>
        </tr>
        <tr>
            <td>HÀ NỘI 3-4-5 NGÀY:</td>
            <td><input type="text" name="mhn3nevendl_product" value="" size="100"/></td>
        </tr>
        <tr>
            <td>&nbsp;</td>
            <td><div id="khmhn3nhe-product" class="scrollbox" style="width:80%">
                <?php $class = 'odd'; ?>
                <?php $cb = 1;?>
                <?php foreach ($khmhn3nevendl_product_box as $product) { ?>
                <?php $class = ($class == 'even' ? 'odd' : 'even'); ?>
              ...
              <input type="hidden" name="khmhn3nevendl_product" value="<?php echo $khmhn3nevendl_product; ?>" /></td>
        </tr>
        <tr>
            <td>HÀ NỘI 6 NGÀY TRỞ LÊN:</td>
            <td><input type="text" name="mhn6nevendl_product" value="" size="100"/></td>
        </tr>
        <tr>
            <td>&nbsp;</td>
            <td><div id="khmhn6nhe-product" class="scrollbox" style="width:80%">
                <?php $class = 'odd'; ?>
                <?php $cb = 1;?>
                <?php foreach ($khmhn6nevendl_product_box as $product) { ?>
                <?php $class = ($class == 'even' ? 'odd' : 'even'); ?>
              ...
              <input type="hidden" name="khmhn6nevendl_product" value="<?php echo $khmhn6nevendl_product; ?>" /></td>
       </tr>
       <tr>
            <td>HẠ LONG 1 -2 NGÀY:</td>
            <td><input type="text" name="mhl1nevendl_product" value="" size="100"/></td>
        </tr>
        <tr>
            <td>&nbsp;</td>
            <td><div id="khmhl1nhe-product" class="scrollbox" style="width:80%">
                <?php $class = 'odd'; ?>
                <?php $cb = 1;?>
                <?php foreach ($khmhl1nevendl_product_box as $product) { ?>
                <?php $class = ($class == 'even' ? 'odd' : 'even'); ?>
              ...
              <input type="hidden" name="khmhl1nevendl_product" value="<?php echo $khmhl1nevendl_product; ?>" /></td>
        </tr>
        <tr>
            <td>HẠ LONG 3-4-5 NGÀY:</td>
            <td><input type="text" name="mhl3nevendl_product" value="" size="100"/></td>
        </tr>
        <tr>
            <td>&nbsp;</td>
            <td><div id="khmhl3nhe-product" class="scrollbox" style="width:80%">
                <?php $class = 'odd'; ?>
                <?php $cb = 1;?>
                <?php foreach ($khmhl3nevendl_product_box as $product) { ?>
                <?php $class = ($class == 'even' ? 'odd' : 'even'); ?>
              ...
              <input type="hidden" name="khmhl3nevendl_product" value="<?php echo $khmhl3nevendl_product; ?>" /></td>
        </tr>
        <tr>
            <td>HẠ LONG 6 NGÀY TRỞ LÊN:</td>
            <td><input type="text" name="mhl6nevendl_product" value="" size="100"/></td>
        </tr>
        <tr>
            <td>&nbsp;</td>
            <td><div id="khmhl6nhe-product" class="scrollbox" style="width:80%">
                <?php $class = 'odd'; ?>
                <?php $cb = 1;?>
                <?php foreach ($khmhl6nevendl_product_box as $product) { ?>
                <?php $class = ($class == 'even' ? 'odd' : 'even'); ?>
              ...
              <input type="hidden" name="khmhl6nevendl_product" value="<?php echo $khmhl6nevendl_product; ?>" /></td>
       </tr>
        <tr>
            <td>SA PA 1 -2 NGÀY:</td>
            <td><input type="text" name="msp1nevendl_product" value="" size="100"/></td>
        </tr>
        <tr>
            <td>&nbsp;</td>
            <td><div id="khmsp1nhe-product" class="scrollbox" style="width:80%">
                <?php $class = 'odd'; ?>
                <?php $cb = 1;?>
                <?php foreach ($khmsp1nevendl_product_box as $product) { ?>
                <?php $class = ($class == 'even' ? 'odd' : 'even'); ?>
              ...
              <input type="hidden" name="khmsp1nevendl_product" value="<?php echo $khmsp1nevendl_product; ?>" /></td>
        </tr>
        <tr>
            <td>SA PA 3-4-5 NGÀY:</td>
            <td><input type="text" name="msp3nevendl_product" value="" size="100"/></td>
        </tr>
        <tr>
            <td>&nbsp;</td>
            <td><div id="khmsp3nhe-product" class="scrollbox" style="width:80%">
                <?php $class = 'odd'; ?>
                <?php $cb = 1;?>
                <?php foreach ($khmsp3nevendl_product_box as $product) { ?>
                <?php $class = ($class == 'even' ? 'odd' : 'even'); ?>
              ...
              <input type="hidden" name="khmsp3nevendl_product" value="<?php echo $khmsp3nevendl_product; ?>" /></td>
        </tr>
        <tr>
            <td>SA PA 6 NGÀY TRỞ LÊN:</td>
            <td><input type="text" name="msp6nevendl_product" value="" size="100"/></td>
        </tr>
        <tr>
            <td>&nbsp;</td>
            <td><div id="khmsp6nhe-product" class="scrollbox" style="width:80%">
                <?php $class = 'odd'; ?>
                <?php $cb = 1;?>
                <?php foreach ($khmsp6nevendl_product_box as $product) { ?>
                <?php $class = ($class == 'even' ? 'odd' : 'even'); ?>
              ...
              <input type="hidden" name="khmsp6nevendl_product" value="<?php echo $khmsp6nevendl_product; ?>" /></td>
       </tr>
          <tr>
            <td>Title:</td>
            <td><input type="text" name="evendl_customtitle" value="<?php echo $evendl_customtitle; ?>" size="100" /></td>
          </tr>
          <tr>
            <td>Name:</td>
            <td><input type="text" name="evendl_title" value="<?php echo $evendl_title; ?>" size="100"/></td>
          </tr>
          <tr>
            <td>Meta Keyword:</td>
            <td><input type="text" name="evendl_metakey" value="<?php echo $evendl_metakey; ?>" size="100"/></td>
          </tr>
          <tr>
            <td>Meta Description:</td>
            <td><input type="text" name="evendl_metadesc" value="<?php echo $evendl_metadesc; ?>" size="100"/></td>
          </tr>
          <tr>
            <td>Description:</td>
            <td><textarea name="evendl_desc" id="evendl_desc"><?php echo $even29_desc; ?></textarea></td>
          </tr>
        </table>
      </form>
    </div>
...
$('input[name=\'msg1nevendl_product\']')
    .autocomplete({
        delay: 0,
      ...
      console.log(data);
            $('input[name=\'khmsg1nevendl_product\']')
...
$('input[name=\'msg3nevendl_product\']')
    .autocomplete({
        delay: 0,
        source: function(request, response) {
            $.ajax({
        ...
        select: function(event, ui) {
            ...
            $('input[name=\'khmsg3nevendl_product\']')
                .attr('value', data.join());
            numsg3n();
            return false;
        },
...
$('input[name=\'msg6nevendl_product\']')
    .autocomplete({
        delay: 0,
        source: function(request, response) {
            $.ajax({
        ...
        select: function(event, ui) {
            ...
            $('input[name=\'khmsg6nevendl_product\']')
                .attr('value', data.join());
            numsg6n();
            return false;
        },
...
// 
$('input[name=\'mmt1nevendl_product\']')
    .autocomplete({
        delay: 0,
        source: function(request, response) {
            $.ajax({
        ...
        select: function(event, ui) {
            ...
            console.log(data);
            $('input[name=\'khmmt1nevendl_product\']')
                .attr('value', data.join());
            nummt1n();
            return false;
        },
...
$('input[name=\'mmt3nevendl_product\']')
    .autocomplete({
        delay: 0,
        source: function(request, response) {
            $.ajax({
        ...
        select: function(event, ui) {
            ...
            $('input[name=\'khmmt3nevendl_product\']')
                .attr('value', data.join());
            nummt3n();
            return false;
        },
...
$('input[name=\'mmt6nevendl_product\']')
    .autocomplete({
        delay: 0,
        source: function(request, response) {
            $.ajax({
        ...
        select: function(event, ui) {
            ...
            $('input[name=\'khmmt6nevendl_product\']')
                .attr('value', data.join());
            nummt6n();
            return false;
        },
...
$('input[name=\'mvt1nevendl_product\']')
    .autocomplete({
        delay: 0,
        source: function(request, response) {
            $.ajax({
        ...
        select: function(event, ui) {
            ...
            console.log(data);
            $('input[name=\'khmvt1nevendl_product\']')
                .attr('value', data.join());
            numsg1n();
            return false;
        },
...
$('input[name=\'mvt3nevendl_product\']')
    .autocomplete({
        delay: 0,
        source: function(request, response) {
            $.ajax({
        ...
        select: function(event, ui) {
            ...
            $('input[name=\'khmvt3nevendl_product\']')
                .attr('value', data.join());
            numvt3n();
            return false;
        },
...
$('input[name=\'mvt6nevendl_product\']')
    .autocomplete({
        delay: 0,
        source: function(request, response) {
            $.ajax({
        ...
        select: function(event, ui) {
            ...
            $('input[name=\'khmvt6nevendl_product\']')
                .attr('value', data.join());
            numvt3n();
            return false;
        },
...
$('input[name=\'mpq1nevendl_product\']')
    .autocomplete({
        delay: 0,
        source: function(request, response) {
            $.ajax({
        ...
        select: function(event, ui) {
            ...
            $('input[name=\'khmpq1nevendl_product\']')
                .attr('value', data.join());
            numpq1n();
            return false;
        },
...
$('input[name=\'mpq3nevendl_product\']')
    .autocomplete({
        delay: 0,
        source: function(request, response) {
            $.ajax({
        ...
        select: function(event, ui) {
            ...
            $('input[name=\'khmpq3nevendl_product\']')
                .attr('value', data.join());
            numpq3n();
            return false;
        },
...
$('input[name=\'mpq6nevendl_product\']')
    .autocomplete({
        delay: 0,
        source: function(request, response) {
            $.ajax({
        ...
        select: function(event, ui) {
            ...
            $('input[name=\'khmpq6nevendl_product\']')
                .attr('value', data.join());
            numpq6n();
            return false;
        },
...
// phan thiet
$('input[name=\'mpt1nevendl_product\']')
    .autocomplete({
        delay: 0,
        source: function(request, response) {
            $.ajax({
        ...
        select: function(event, ui) {
            ...
            $('input[name=\'khmpt1nevendl_product\']')
                .attr('value', data.join());
            numpt1n();
            return false;
        },
...
$('input[name=\'mpt3nevendl_product\']')
    .autocomplete({
        delay: 0,
        source: function(request, response) {
            $.ajax({
        ...
        select: function(event, ui) {
            ...
            $('input[name=\'khmpt3nevendl_product\']')
                .attr('value', data.join());
            numpt3n();
            return false;
        },
...
$('input[name=\'mpt6nevendl_product\']')
    .autocomplete({
        delay: 0,
        source: function(request, response) {
            $.ajax({
        ...
        select: function(event, ui) {
            ...
            $('input[name=\'khmpt6nevendl_product\']')
                .attr('value', data.join());
            numpt6n();
            return false;
        },
...
// Đà lạt
$('input[name=\'mdl1nevendl_product\']')
    .autocomplete({
        delay: 0,
        source: function(request, response) {
            $.ajax({
        ...
        select: function(event, ui) {
            ...
            $('input[name=\'khmdl1nevendl_product\']')
                .attr('value', data.join());
            numdl1n();
            return false;
        },
...
$('input[name=\'mdl3nevendl_product\']')
    .autocomplete({
        delay: 0,
        source: function(request, response) {
            $.ajax({
        ...
        select: function(event, ui) {
            ...
            $('input[name=\'khmdl3nevendl_product\']')
                .attr('value', data.join());
            numdl3n();
            return false;
        },
...
$('input[name=\'mdl6nevendl_product\']')
    .autocomplete({
        delay: 0,
        source: function(request, response) {
            $.ajax({
        ...
        select: function(event, ui) {
            ...
            $('input[name=\'khmdl6nevendl_product\']')
                .attr('value', data.join());
            numdl6n();
            return false;
        },
...
// Nha Trang
// Đà lạt
$('input[name=\'mnt1nevendl_product\']')
    .autocomplete({
        delay: 0,
        source: function(request, response) {
            $.ajax({
        ...
        select: function(event, ui) {
            ...
            $('input[name=\'khmnt1nevendl_product\']')
                .attr('value', data.join());
            numnt1n();
            return false;
        },
...
$('input[name=\'mnt3nevendl_product\']')
    .autocomplete({
        delay: 0,
        source: function(request, response) {
            $.ajax({
        ...
        select: function(event, ui) {
            ...
            $('input[name=\'khmnt3nevendl_product\']')
                .attr('value', data.join());
            numnt3n();
            return false;
        },
...
$('input[name=\'mnt6nevendl_product\']')
    .autocomplete({
        delay: 0,
        source: function(request, response) {
            $.ajax({
        ...
        select: function(event, ui) {
            ...
            $('input[name=\'khmnt6nevendl_product\']')
                .attr('value', data.join());
            numnt6n();
            return false;
        },
    ...
    // đà nẵng
$('input[name=\'mdn1nevendl_product\']')
    .autocomplete({
        delay: 0,
        source: function(request, response) {
            $.ajax({
        ...
        select: function(event, ui) {
            ...
            $('input[name=\'khmdn1nevendl_product\']')
                .attr('value', data.join());
            numdn1n();
            return false;
        },
...
$('input[name=\'mdn3nevendl_product\']')
    .autocomplete({
        delay: 0,
        source: function(request, response) {
            $.ajax({
        ...
        select: function(event, ui) {
            ...
            $('input[name=\'khmdn3nevendl_product\']')
                .attr('value', data.join());
            numdn3n();
            return false;
        },
...
$('input[name=\'mdn6nevendl_product\']')
    .autocomplete({
        delay: 0,
        source: function(request, response) {
            $.ajax({
        ...
        select: function(event, ui) {
            ...
            $('input[name=\'khmdn6nevendl_product\']')
                .attr('value', data.join());
            numdn6n();
            return false;
        },
...
// Hôi an
$('input[name=\'mha1nevendl_product\']')
    .autocomplete({
        delay: 0,
        source: function(request, response) {
            $.ajax({
        ...
        select: function(event, ui) {
            ...
            $('input[name=\'khmha1nevendl_product\']')
                .attr('value', data.join());
            numha1n();
            return false;
        },
...
$('input[name=\'mha3nevendl_product\']')
    .autocomplete({
        delay: 0,
        source: function(request, response) {
            $.ajax({
        ...
        select: function(event, ui) {
            ...
            $('input[name=\'khmha3nevendl_product\']')
                .attr('value', data.join());
            numha3n();
            return false;
        },
...
$('input[name=\'mha6nevendl_product\']')
    .autocomplete({
        delay: 0,
        source: function(request, response) {
            $.ajax({
        ...
        select: function(event, ui) {
            ...
            $('input[name=\'khmha6nevendl_product\']')
                .attr('value', data.join());
            numha6n();
            return false;
        },
    ...
    // Huế
    $('input[name=\'mhue1nevendl_product\']')
    .autocomplete({
        delay: 0,
        source: function(request, response) {
            $.ajax({
        ...
        select: function(event, ui) {
            ...
            $('input[name=\'khmhue1nevendl_product\']')
                .attr('value', data.join());
            numhue1n();
            return false;
        },
...
$('input[name=\'mhue3nevendl_product\']')
    .autocomplete({
        delay: 0,
        source: function(request, response) {
            $.ajax({
        ...
        select: function(event, ui) {
            ...
            $('input[name=\'khmhue3nevendl_product\']')
                .attr('value', data.join());
            numhue3n();
            return false;
        },
...
$('input[name=\'mhue6nevendl_product\']')
    .autocomplete({
        delay: 0,
        source: function(request, response) {
            $.ajax({
        ...
        select: function(event, ui) {
            ...
            $('input[name=\'khmhue6nevendl_product\']')
                .attr('value', data.join());
            numhue6n();
            return false;
        },
...
// Hà nội
$('input[name=\'mhn1nevendl_product\']')
    .autocomplete({
        delay: 0,
        source: function(request, response) {
            $.ajax({
        ...
        select: function(event, ui) {
            ...
            $('input[name=\'khmhn1nevendl_product\']')
                .attr('value', data.join());
            numhn1n();
            return false;
        },
...
$('input[name=\'mhn3nevendl_product\']')
    .autocomplete({
        delay: 0,
        source: function(request, response) {
            $.ajax({
        ...
        select: function(event, ui) {
            ...
            $('input[name=\'khmhn3nevendl_product\']')
                .attr('value', data.join());
            numhn3n();
            return false;
        },
...
$('input[name=\'mhn6nevendl_product\']')
    .autocomplete({
        delay: 0,
        source: function(request, response) {
            $.ajax({
        ...
        select: function(event, ui) {
            ...
            $('input[name=\'khmhn6nevendl_product\']')
                .attr('value', data.join());
            numhn6n();
            return false;
        },
...
// Hạ long
$('input[name=\'mhl1nevendl_product\']')
    .autocomplete({
        delay: 0,
        source: function(request, response) {
            $.ajax({
        ...
        select: function(event, ui) {
            ...
            $('input[name=\'khmhl1nevendl_product\']')
                .attr('value', data.join());
            numhl1n();
            return false;
        },
...
$('input[name=\'mhl3nevendl_product\']')
    .autocomplete({
        delay: 0,
        source: function(request, response) {
            $.ajax({
        ...
        select: function(event, ui) {
            ...
            $('input[name=\'khmhl3nevendl_product\']')
                .attr('value', data.join());
            numhl3n();
            return false;
        },
...
$('input[name=\'mhl6nevendl_product\']')
    .autocomplete({
        delay: 0,
        source: function(request, response) {
            $.ajax({
        ...
        select: function(event, ui) {
            ...
            $('input[name=\'khmhl6nevendl_product\']')
                .attr('value', data.join());
            numhl6n();
            return false;
        },
...
$('input[name=\'msp1nevendl_product\']')
    .autocomplete({
        delay: 0,
        source: function(request, response) {
            $.ajax({
        ...
        select: function(event, ui) {
            ...
            $('input[name=\'khmsp1nevendl_product\']')
                .attr('value', data.join());
            numsp1n();
            return false;
        },
...
$('input[name=\'msp3nevendl_product\']')
    .autocomplete({
        delay: 0,
        source: function(request, response) {
            $.ajax({
        ...
        select: function(event, ui) {
            ...
            $('input[name=\'khmsp3nevendl_product\']')
                .attr('value', data.join());
            numsp3n();
            return false;
        },
...
$('input[name=\'msp6nevendl_product\']')
    .autocomplete({
        delay: 0,
        source: function(request, response) {
            $.ajax({
        ...
        select: function(event, ui) {
            ...
            $('input[name=\'khmsp6nevendl_product\']')
                .attr('value', data.join());
            numsp6n();
            return false;
        },
