      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <table class="form">
          <tr>
            ...
            <td><input type="text" name="msg1nhe_product" value="" size="100"/></td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td><div id="khmsg1nhe-product" class="scrollbox" style="width:80%">
                <?php $class = 'odd'; ?>
                <?php $cn = 1;?>
                <?php foreach ($khmsg1nhe_product_box as $product) { ?>
              ...
              <input type="hidden" name="khmsg1nhe_product" value="<?php echo $khmsg1nhe_product; ?>" /></td>
          </tr>
          <tr>
            <td>SÀI GÒN TOUR 3 NGÀY TRỞ LÊN:</td>
            <td><input type="text" name="msg3nhe_product" value=""size="100" /></td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td><div id="khmsg3nhe-product" class="scrollbox" style="width:80%">
                <?php $class = 'odd'; ?>
                <?php $ct = 1;?>
                <?php foreach ($khmsg3nhe_product_box as $product) { ?>
                <?php $class = ($class == 'even' ? 'odd' : 'even'); ?>
              ...
              <input type="hidden" name="khmsg3nhe_product" value="<?php echo $khmsg3nhe_product; ?>" /></td>
          </tr>
          <tr>
            <td>PHAN THIẾT 1 - 2 NGÀY:</td>
            <td><input type="text" name="mpt1nhe_product" value="" size="100"/></td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td><div id="khmpt1nhe-product" class="scrollbox" style="width:80%">
                <?php $class = 'odd'; ?>
                <?php $cb = 1;?>
                <?php foreach ($khmpt1nhe_product_box as $product) { ?>
                <?php $class = ($class == 'even' ? 'odd' : 'even'); ?>
              ...
              <input type="hidden" name="khmpt1nhe_product" value="<?php echo $khmpt1nhe_product; ?>" /></td>
          </tr>
          <tr>
            <td>PHAN THIẾT 3 TRỞ LÊN:</td>
            <td><input type="text" name="mpt3nhe_product" value="" size="100"/></td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td><div id="khmpt3nhe-product" class="scrollbox" style="width:80%">
                <?php $class = 'odd'; ?>
                <?php $cb = 1;?>
                <?php foreach ($khmpt3nhe_product_box as $product) { ?>
                <?php $class = ($class == 'even' ? 'odd' : 'even'); ?>
              ...
              <input type="hidden" name="khmpt3nhe_product" value="<?php echo $khmpt3nhe_product; ?>" /></td>
          </tr>
          <tr>
            <td>ĐÀ NẴNG 1 -2 NGÀY:</td>
            <td><input type="text" name="mdn1nhe_product" value="" size="100"/></td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td><div id="khmdn1nhe-product" class="scrollbox" style="width:80%">
                <?php $class = 'odd'; ?>
                <?php $cb = 1;?>
                <?php foreach ($khmdn1nhe_product_box as $product) { ?>
                <?php $class = ($class == 'even' ? 'odd' : 'even'); ?>
              ...
              <input type="hidden" name="khmdn1nhe_product" value="<?php echo $khmdn1nhe_product; ?>" /></td>
          </tr>
          <tr>
            <td>ĐÀ NẴNG 3 NGÀY TRỞ LÊN:</td>
            <td><input type="text" name="mdn3nhe_product" value="" size="100"/></td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td><div id="khmdn3nhe-product" class="scrollbox" style="width:80%">
                <?php $class = 'odd'; ?>
                <?php $cb = 1;?>
                <?php foreach ($khmdn3nhe_product_box as $product) { ?>
                <?php $class = ($class == 'even' ? 'odd' : 'even'); ?>
              ...
              <input type="hidden" name="khmdn3nhe_product" value="<?php echo $khmdn3nhe_product; ?>" /></td>
          </tr>
          <tr>
            <td>HÀ NỘI 1 -2 NGÀY:</td>
            <td><input type="text" name="mhn1nhe_product" value="" size="100"/></td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td><div id="khmhn1nhe-product" class="scrollbox" style="width:80%">
                <?php $class = 'odd'; ?>
                <?php $cb = 1;?>
                <?php foreach ($khmhn1nhe_product_box as $product) { ?>
                <?php $class = ($class == 'even' ? 'odd' : 'even'); ?>
              ...
              <input type="hidden" name="khmhn1nhe_product" value="<?php echo $khmhn1nhe_product; ?>" /></td>
          </tr>
          <tr>
            <td>HÀ NỘI 3 NGÀY TRỞ LÊN:</td>
            <td><input type="text" name="mhn3nhe_product" value="" size="100"/></td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td><div id="khmhn3nhe-product" class="scrollbox" style="width:80%">
                <?php $class = 'odd'; ?>
                <?php $cb = 1;?>
                <?php foreach ($khmhn3nhe_product_box as $product) { ?>
                <?php $class = ($class == 'even' ? 'odd' : 'even'); ?>
              ...
              <input type="hidden" name="khmhn3nhe_product" value="<?php echo $khmhn3nhe_product; ?>" /></td>
          </tr>
          <tr>
            <td>PHÚ QUỐC 1 - 2 NGÀY:</td>
            <td><input type="text" name="mpq1nhe_product" value="" size="100"/></td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td><div id="khmpq1nhe-product" class="scrollbox" style="width:80%">
                <?php $class = 'odd'; ?>
                <?php $cb = 1;?>
                <?php foreach ($khmpq1nhe_product_box as $product) { ?>
                <?php $class = ($class == 'even' ? 'odd' : 'even'); ?>
              ...
              <input type="hidden" name="khmpq1nhe_product" value="<?php echo $khmpq1nhe_product; ?>" /></td>
          </tr>
          <tr>
            <td>PHÚ QUỐC 3 NGÀY TRỞ LÊN:</td>
            <td><input type="text" name="mpq3nhe_product" value="" size="100"/></td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td><div id="khmpq3nhe-product" class="scrollbox" style="width:80%">
                <?php $class = 'odd'; ?>
                <?php $cb = 1;?>
                <?php foreach ($khmpq3nhe_product_box as $product) { ?>
                <?php $class = ($class == 'even' ? 'odd' : 'even'); ?>
              ...
              <input type="hidden" name="khmpq3nhe_product" value="<?php echo $khmpq3nhe_product; ?>" /></td>
          </tr>
          <tr>
            <td>Title:</td>
            <td><input type="text" name="he_customtitle" value="<?php echo $he_customtitle; ?>" size="100" /></td>
          </tr>
          <tr>
            <td>Name:</td>
            <td><input type="text" name="he_title" value="<?php echo $he_title; ?>" size="100"/></td>
          </tr>
          <tr>
            <td>Meta Keyword:</td>
            <td><input type="text" name="he_metakey" value="<?php echo $he_metakey; ?>" size="100"/></td>
          </tr>
          <tr>
            <td>Meta Description:</td>
            <td><input type="text" name="he_metadesc" value="<?php echo $he_metadesc; ?>" size="100"/></td>
          </tr>
          <tr>
            <td>Description:</td>
            <td><textarea name="he_desc" id="he_desc"><?php echo $he_desc; ?></textarea></td>
          </tr>
        </table>
      </form>
    </div>
