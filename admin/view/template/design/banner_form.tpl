        ...
        <table id="images" class="list">
          <thead>
            <tr>
              ...
              <td class="left"><?php echo $oder; ?></td>
              <td></td>
            </tr>
          </thead>
          <?php $image_row = 0; ?>
          ...
          <tbody id="image-row<?php echo $image_row; ?>">
            <tr>
                ...
                <td><input type="text" name="banner_image[<?php echo $image_row; ?>][start_date]" value="<?php echo $banner_image['start_date']; ?>" class="date" /></td>
                <td><input type="text" name="banner_image[<?php echo $image_row; ?>][end_date]" value="<?php echo $banner_image['end_date']; ?>" class="date" /></td>
                ...
                <td><input type="text" name="banner_image[<?php echo $image_row; ?>][oder]" value="<?php echo $banner_image['oder']; ?>" /></td>
                <td class="left"><a onclick="$('#image-row<?php echo $image_row; ?>').remove();" class="button"><?php echo $button_remove; ?></a></a></td>
            </tr>
          </tbody>
          <?php $image_row++; ?>
          <?php }?>
...
function addImage() {
	...
	html += '<td class="left"><input type="text" class="date" name="banner_image[' + image_row + '][start_date]" value="0000-00-00" /></td>';
	html += '<td class="left"><input type="text" class="date" name="banner_image[' + image_row + '][end_date]" value="0000-00-00" /></td>';
    ...
    html += '<td class="left"><input type="text" name="banner_image[' + image_row + '][order]" value="0" /></td>';
