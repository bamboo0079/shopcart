...
<div id="content">
    <div class="breadcrumb">
        <a href="<?php echo $breadcrumbs['href'];?>"><?php echo $breadcrumbs['text'];?></a>::
        <a href="<?php echo $breadcrumbs['text_category_href'];?>"><?php echo $breadcrumbs['text_category'];?></a>
    </div>
    <div class="box">
        <div class="heading">
            <h1><img alt="" src="view/image/user-group.png"> <?php echo $text_add_category_menu;?></h1>
        ...
        $('body').delegate('#sl-next','click',function(){
            ...
            input.each(function(){
                if($(this).is(':checked')){
                    ...
                    html += '<input type="checkbox" value="'+id+'" name="cat_menu_choose[]">'+text+'';
