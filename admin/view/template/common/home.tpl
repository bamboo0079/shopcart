          ...
          <table class="list">
            <thead>
              <tr>
                ...
                <td class="left">NV Đang xử lý</td>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="left">
                <?php 
                  $userlog = $this->user->getUserNameByOrder($order['order_id']);
                  if (!empty($userlog)) {
                    echo $this->user->getUserNameByOrder($order['order_id']); 
                  } else {
                ...
                <td class="right"><?php if($order['total_event'] != '0₫'){echo $order['total_event'];}else{ echo $order['total'];} ?></td>
