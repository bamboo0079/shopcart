...
<script type="text/javascript" charset="utf-8">
    ...
    elFinder.prototype.i18.en.messages['cmdmultiupload'] = 'Add selected to product';
		...
		var elf = $('#container').elfinder({
			...
			defaultView: 'list',
      uiOptions : {toolbar : [['home', 'back', 'forward'],['reload'],['mkdir', 'upload'],['open', 'download', 'getfile'],['info'],['quicklook'],['copy', 'cut', 'paste'],['rm'],['duplicate', 'rename', 'edit', 'resize'],['search'],['view']]},		
