      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <div id="tab-general">
          <div id="vtabs" class="vtabs"><a href="#tab-customer"><?php echo $tab_general; ?></a>
            ...
            <a href="#tab-address-<?php echo $address_row; ?>" id="address-<?php echo $address_row; ?>"><?php echo $tab_address;?></a>
            <?php $address_row++; ?>
            <?php } ?>
            <span id="address-add" style="display:none"><?php echo $button_add_address; ?>&nbsp;<img src="view/image/add.png" alt="" onclick="addAddress();" /></span></div> 
          <div id="tab-customer" class="vtabs-content">
            <table class="form">
              <tr>
                <td><span class="required">*</span> <?php echo $entry_lastname; ?></td>
                <td><input type="text" name="lastname" value="<?php echo $lastname; ?>" size="50" autocomplete="off"/>
              ...
              <tr>
                ...
                <td><input type="text" name="firstname" value="<?php echo $firstname; ?>" size="50" autocomplete="off"/>
             ...
             <tr>
              ...
              <td>
                    <select name="birthday_day" data-validation="required">
                    ...
                    <select name="birthday_month" data-validation="required">
                    ...
                    <select name="birthday_year" data-validation="required">
              ...
              <tr>
                ...
                <td><input type="text" name="telephone" value="<?php echo $telephone; ?>" size="20" maxlength="11"/>
              ...
              <tr>
                ...
                <td><select name="customer_type_id">
                    <?php foreach ($customer_types as $customer_type) { ?>
                    <?php if ($customer_type['customer_type_id'] == $customer_type_id) { ?>
                    <option value="<?php echo $customer_type['customer_type_id']; ?>" selected="selected"><?php echo $customer_type['name']; ?></option>
                    <?php } else { ?>
                    <option value="<?php echo $customer_type['customer_type_id']; ?>"><?php echo $customer_type['name']; ?></option>
                    <?php } ?>
                    <?php } ?>
                  </select></td>
              </tr>
              ...
              <?php if (!$customer_id) { ?>
              <tr>
                <td><?php echo $entry_send_mail; ?></td>
          ...
          <div id="tab-address-<?php echo $address_row; ?>" class="vtabs-content">
            ...
            <table class="form">
              <tr style="display:none">
                <td><span class="required">*</span> <?php echo $entry_lastname; ?></td>
                <td><input type="text" name="address[<?php echo $address_row; ?>][lastname]" value="<?php echo $address['lastname']; ?>"  size="50" class="address_lastname"/>
              ...
              <tr style="display:none">
                <td><span class="required">*</span> <?php echo $entry_firstname; ?></td>
                <td><input type="text" name="address[<?php echo $address_row; ?>][firstname]" value="<?php echo $address['firstname']; ?>" size="50" class="address_firstname"/>
              ...
              <tr>
                ...
                <td><input type="text" name="address[<?php echo $address_row; ?>][address_1]" value="<?php echo $address['address_1']; ?>" size="50"/>
...
$('input[name="lastname"]').bind('keyup',function(){
	$('.address_lastname').val($(this).val());
});
$('input[name="firstname"]').bind('keyup',function(){
	$('.address_firstname').val($(this).val());
});
</script>
...
if(address_row <= 1){
	...
	html += '      <td><input type="text" name="address[' + address_row + '][lastname]" value="" size="50" class="address_lastname"/></td>';
	html += '    </tr>'; 
	html += '    <tr style="display:none">';
	html += '	   <td><span class="required">*</span> <?php echo $entry_firstname; ?></td>';
	html += '	   <td><input type="text" name="address[' + address_row + '][firstname]" value="" size="50" class="address_firstname"/></td>';
	html += '    </tr>';
	html += '    <tr style="display:none">';
	...
	html += '      <td><input type="text" name="address[' + address_row + '][address_1]" value="" size="50"/></td>';
	html += '    </tr>';
	html += '    <tr style="display:none">';
	...
	html += '      <td><select name="address[' + address_row + '][country_id]" class="address_country_id" onchange="country(this, \'' + address_row + '\', \'0\');">';
	html += '         <option value=""><?php echo $text_select; ?></option>';
	<?php foreach ($countries as $country) { ?>
	...
	html += '      <td><select name="address[' + address_row + '][zone_id]" class="address_zone_id"><option value="false"><?php echo $this->language->get('text_none'); ?></option></select></td>';
	html += '    </tr>';
	html += '    <tr style="display:none">';
	...
	$('#address-add').before('<a href="#tab-address-' + address_row + '" id="address-' + address_row + '"><?php echo $tab_address; ?> ' + '</a>');
		 
	$('.vtabs a').tabs();
	
	$('#address-' + address_row).trigger('click');
	
	$('.address_country_id').val(230).trigger('change');
