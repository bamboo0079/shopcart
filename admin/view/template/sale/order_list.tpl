...
<div id="content">
  ...
  <div class="box">
    <div class="heading">
      ...
      <div class="buttons"><a href="<?php echo $insert; ?>" class="button"><?php echo $button_insert; ?></a><a onclick="$('#form').attr('action', '<?php echo $delete; ?>'); $('#form').attr('target', '_self'); $('#form').submit();" class="button"><?php echo $button_delete; ?></a></div>
    </div>
    <div class="content">
        ...
        <table class="list">
          <thead>
            <tr>
              ...
              <td class="right" width="60px"><?php if ($sort == 'o.order_id') { ?>
              ...
              <td class="left"><?php if ($sort == 'o.date_modified') { ?>
                ...
                <?php } ?></td>
              <td class="center"><?php echo $column_manager; ?></td>
          ...
          <tbody>
            <tr class="filter">
              ...
              <td><input type="text" name="filter_date" value="<?php echo $filter_date; ?>" size="12" class="date" /></td>
              ...
              <td><select name="filter_order_user">
                  echo '<option value="*"></option>'
                  <?php 
                  foreach ($results_user as $value) { 
                    if ($filter_order_user == $value['username']) {
                      echo '<option value="'.$filter_order_user.'" selected="selected">'.$filter_order_user.'</option>';
                    }else{
            ...
            <tr>
              ...
              <?php if($order['date']){?>
              <?php $tmp = '';?>
                <?php foreach($order['date'] as $item) {?>
                    <?php if($item['type'] == 'date' && $item['value'] != $tmp){?>
                    <?php if($item['value'] == datedata_to_date($filter_date)){?>
                    <b>- <?php echo $item['value'];?></b> <br />
                    <?php }else{?>
...
$('input[name=\'filter_customer\']').catcomplete({
	...
	select: function(event, ui) {
		$('input[name=\'filter_customer\']').val(ui.item.name);
