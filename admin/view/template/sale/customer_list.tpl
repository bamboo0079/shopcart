...
<div id="content">
  ...
  <div class="box">
    <div class="heading">
      ...
      <div class="buttons"><a onclick="$('form').attr('action', '<?php echo $update_group; ?>'); $('form').submit();" class="button"><?php echo $button_update_group; ?></a><a href="<?php echo $insert; ?>" class="button"><?php echo $button_insert; ?></a><a onclick="$('form').attr('action', '<?php echo $delete; ?>'); $('form').submit();" class="button"><?php echo $button_delete; ?></a></div>
    </div>
    <div class="content">
        ...
        <table class="list">
          <thead>
            <tr>
              ...
              <td class="left"><?php if ($sort == 'c.email') { ?>
                ...
                <?php } ?></td>
              <td class="left"><?php if ($sort == 'customer_type') { ?>
                <a href="<?php echo $sort_customer_type; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_customer_type; ?></a>
                <?php } else { ?>
                <a href="<?php echo $sort_customer_type; ?>"><?php echo $column_customer_type; ?></a>
                <?php } ?></td>
              <td class="left" width="120px"><?php echo $column_zone; ?></td>
          ...
          <tbody>
            <tr class="filter">
              ...
              <td><select name="filter_customer_type_id">
                  <option value="*"></option>
                  <?php foreach ($customer_types as $customer_type) { ?>
                  <?php if ($customer_type['customer_type_id'] == $filter_customer_type_id) { ?>
            ...
            <tr>
              ...
              <td class="left"><?php echo $customer['customer_type']; ?></td>
...
function filter() {
	...
	var filter_customer_type_id = $('select[name=\'filter_customer_type_id\']').attr('value');
	
	if (filter_customer_type_id != '*') {
		url += '&filter_customer_type_id=' + encodeURIComponent(filter_customer_type_id);
	}
