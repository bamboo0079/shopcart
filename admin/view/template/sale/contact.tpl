    ...
    <div class="content">
        <table id="mail" class="form">
          ...
          <tr>
            ...
            <td><select name="to">
                <option value="newsletter"><?php echo $text_newsletter ." - ".$newsletter; ?>mail</option>
                <option value="customer_all"><?php echo $text_customer_all; ?></option>
                <option value="customer_group"><?php echo $text_customer_group; ?></option>
                <option value="customer"><?php echo $text_customer; ?></option>
                <option value="list_email"><?php echo $text_list_email; ?></option>
                <option value="affiliate_all" style="display:none"><?php echo $text_affiliate_all; ?></option>
                <option value="affiliate" style="display:none"><?php echo $text_affiliate; ?></option>
                <option value="product" style="display:none"><?php echo $text_product; ?></option>
              </select>
              Tổng mail là :<?php echo $total_mail;?>
              </td>
          </tr>
          <tbody id="to-list-email" class="to">
          	<tr>
              <td><?php echo $entry_list_email; ?></td>
              <td><textarea name="list_email" style="width:600px;height:150px;"></textarea></td>
            </tr>
          </tbody>
                  ...
                  <option value="<?php echo $customer_group['customer_group_id']; ?>">
		                  ...
		                  if ($data_group) {
			                  foreach ($data_group as $key => $value) {
				                  	if ($key == $customer_group['customer_group_id']) {
				                  		echo " - ".$value ."mail";
				                  	}
			                  }
		                  }
          ...
          <tbody id="to-customer" class="to">
            <tr>
              ...
              <td><input type="text" name="customers" value="" size="50" /></td>
            </tr>
            <tr>
              <td>&nbsp;</td>
          ...
          <tr>
            ...
            <option value="0">--- Chọn Mail Template ---</option>
...
<script>
$('select[name=\'mail_template\']').bind('change', function() {
	var value = $(this).attr('value');
		$.ajax({
			url: 'index.php?route=sale/mail_template/autocomplete&token=<?php echo $token; ?>&mail_template_id=' + value,
			dataType: 'json',
...
$('input[name=\'customers\']').catcomplete({
	...
	select: function(event, ui) {
		...
		$('#customer').append('<div id="customer' + ui.item.value + '">' + ui.item.name + ' -- ' + ui.item.email + '<img src="view/image/delete.png" alt="" /><input type="hidden" name="customer[]" value="' + ui.item.value + '" /></div>');
