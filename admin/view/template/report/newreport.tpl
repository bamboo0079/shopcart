      ...
      <table class="list">
        <thead>
          <tr>
            ...
            <td class="left"><?php echo $column_postcode; ?></td>
            <td class="left"><?php echo $column_state; ?></td>
            <td class="left"><?php echo $column_email; ?></td>
            <td class="left"><?php echo $column_phone; ?></td>
            <td class="left"><?php echo $column_status; ?></td>
            <td class="right"><?php echo $column_pdtname; ?></td> 
            <td class="right"><?php echo $column_quantity; ?></td> 
            <td class="right"><?php echo $column_options; ?></td> 
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="left"><?php echo $customer['state']; ?></td>
            ...
            <td class="right"><?php echo $customer['options']; ?></td>
