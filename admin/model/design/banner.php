...
class ModelDesignBanner extends Model {
	...
	public function editBanner($banner_id,$language_id, $data) {
		$this->db->query("
			...
			foreach ($data['banner_image'] as $banner_image) {
				$this->db->query("
                                      ...
                                      SET banner_id = '" . (int)$banner_id . "',
                                        start_date = '" . $this->db->escape($banner_image['start_date']) . "',
                                        end_date = '" . $this->db->escape($banner_image['end_date']) . "',
                                      link = '" .  $this->db->escape($banner_image['link']) . "',
                                      image = '" .  $this->db->escape($banner_image['image']) . "',
                                      oder = '" .  (int)$banner_image['oder'] . "'
                                  ");
	...
	public function getBannerImages($banner_id) {
		...
		foreach ($banner_image_query->rows as $banner_image) {
			...
			$banner_image_description_query = $this->db->query("
                                                                SELECT * FROM " . DB_PREFIX . "banner_image_description
