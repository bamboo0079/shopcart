...
class ModelUserUser extends Model {
	...
	public function getNameUsers($user_group_id){
		$query = $this->db->query("SELECT username FROM `" . DB_PREFIX . "user` WHERE user_group_id = '" . (int)$user_group_id . "'");
