...
class ModelCatalogOption extends Model {
	public function addOption($data) {
		$this->db->query("INSERT INTO `" . DB_PREFIX . "option` SET type = '" . $this->db->escape($data['type']) . "', category = '" . $this->db->escape($data['category']) . "', class = '" . $this->db->escape($data['class']) . "', sort_order = '" . (int)$data['sort_order'] . "'");
	...
	public function editOption($option_id, $data) {
		$this->db->query("UPDATE `" . DB_PREFIX . "option` SET type = '" . $this->db->escape($data['type']) . "', category = '" . $this->db->escape($data['category']) . "', class = '" . $this->db->escape($data['class']) . "', sort_order = '" . (int)$data['sort_order'] . "' WHERE option_id = '" . (int)$option_id . "'");
	...
	public function getOptions($data = array()) {
		...
		if (isset($data['filter_class']) && !is_null($data['filter_class'])) {
				$sql .= " AND o.class = '" . (int)$data['filter_class'] . "'";
		}
		
		if (isset($data['filter_category']) && !is_null($data['filter_category'])) {
				$sql .= " AND o.category = '" . (int)$data['filter_category'] . "'";
		}
