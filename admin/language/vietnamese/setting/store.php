...
// Column
$_['column_name']               = 'Tên website';
$_['column_url']	        	= 'URL website';
$_['column_action']             = 'Thao tác';

// Entry
$_['entry_url']                 = 'URL Gian hàng:<br /><span class="help">Bao gồm URL đầy đủ website của bạn. Hãy chắc chắn đã thêm vào \'/\' ở cuối. Ví dụ: http://www.yourdomain.com/path/<br /><br />Không sử dụng thư mục để tạo ra một website mới. Bạn nên luôn luôn điểm khác miền phụ tên miền để lưu trữ của bạn.</span>';
...
$_['entry_catalog_limit'] 	    = 'Mặc định Tìm Mỗi trang(Danh mục):<br /><span class="help">Xác định như thế nào các website nhiều sẽ được hiển thị trên mỗi trang (sản phẩm, chủng loại, vv)</span>';
...
$_['error_url']                 = 'Yêu cầu URL website!';
...
$_['error_store']               = 'Cảnh báo: website này không thể bị xóa vì nó đang dùng cho %s đơn hàng!';
?>