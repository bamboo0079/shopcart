...
$_['entry_currency_auto']     = 'Tự động cập nhật tiền tệ:<br /><span class="help">Chọn để tự động cập nhật các loại tiền tệ hàng ngày cho website của bạn .</span>';
$_['entry_length_class']      = 'Đơn vị đo trọng lượng:';
$_['entry_weight_class']      = 'Đơn vị đo chiều dài:';
$_['entry_catalog_limit'] 	    = 'Mặc định trên Trang (Danh mục):<br /><span class="help">Xác định như thế nào các website nhiều sẽ được hiển thị trên mỗi trang (sản phẩm, chủng loại, vv)</span>';
...
$_['entry_tax_default']        = 'Use Store Tax Address:<br /><span class="help">Sử dụng địa chỉ website để tính thuế nếu không có ai được đăng nhập. Bạn có thể chọn để sử dụng địa chỉ website cho các khách hàng vận chuyển hoặc địa chỉ thanh toán.</span>';
...
$_['entry_alert_mail']          = 'Thư thông báo:<br /><span class="help">Gửi email cho chủ website khi một trật tự mới được tạo ra.</span>';
...
$_['error_owner']               = 'Website phải có từ 3 và 64 ký tự!';
