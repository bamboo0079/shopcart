<?php
/* Khoa add FTP Connector for CDN Images Manager*/
define('FHTTP', 'http://images.you-tek.net');
define('FLINK', '118.69.63.110');
define('FUSER', 'bkman');
define('FPASS', 'vietfun');
define('FPATH', '/lampp/htdocs/images/image');
// HTTP
