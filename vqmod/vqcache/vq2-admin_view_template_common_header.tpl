...
<div id="container">
    <div id="header">
            ...
            <ul class="left" style="display: none;">
                ...
                <li id="catalog"><a class="top"><?php echo $text_catalog; ?></a>
                    <ul>
                        ...
                        <li style="display:none"><a href="<?php echo $profile; ?>"><?php echo $text_profile; ?></a></li>
                        <li><a class="parent"><?php echo $text_attribute; ?></a>
                            <ul>
                                <li><a href="<?php echo $attribute; ?>"><?php echo $text_attribute; ?></a></li>
                                <li><a href="<?php echo $attribute_group; ?>"><?php echo $text_attribute_group; ?></a></li>
                                <li><a href="<?php echo $attribute_type; ?>"><?php echo $text_attribute_type; ?></a></li>
                                <li><a href="<?php echo $attribute_meal; ?>"><?php echo $text_attribute_meal; ?></a></li>
                            </ul>
                        </li>
        ...
        <li><a href="<?php echo $policy; ?>"><?php echo $text_policy; ?></a></li>
          ...
          <li id="comment" style="position:relative"><a class="top" href="<?php echo $comment; ?>"><?php echo $text_comment; ?></a><?php if($total_comment){?><i class="total_comment"><?php echo $total_comment?></i><?php }?></li>
          <li id="employee"><a href="<?php echo $employee; ?>" class="top"><?php echo $text_employee; ?></a></li>
          <li id="extra"><a class="top"><?php echo $text_extra; ?></a>
        <ul>
...
<?php
			...
			<li><a href="<?php echo $library; ?>">Image Manager Plus</a></li>
				...
				<li><a href="<?php echo $cache_manager; ?>"><?php echo $text_cache_manager; ?></a></li>
...
<li id="promotion"><a class="top" href="<?php echo $event; ?>">Event</a>
			<!-- <ul>			
			<li><a href="<?php echo $event; ?>"><?php echo $text_event2; ?></a></li>
                ...
                <li id="sale"><a class="top"><?php echo $text_sale; ?></a>
                    <ul>
                        ...
                        <li style="display:none"><a href="<?php echo $recurring_profile; ?>"><?php echo $text_recurring_profile; ?></a></li>
                        <li style="display:none"><a href="<?php echo $return; ?>"><?php echo $text_return; ?></a></li>
                        <li><a class="parent"><?php echo $text_customer; ?></a>
                            <ul>
                                <li><a href="<?php echo $customer; ?>"><?php echo $text_customer; ?></a></li>
          <li><a href="<?php echo $customer_type; ?>"><?php echo $text_customer_type; ?></a></li>
          ...
          <li><a href="<?php echo $mail_template; ?>"><?php echo $text_mail_template; ?></a></li>
                        <li><a href="<?php echo $contact; ?>"><?php echo $text_contact; ?></a></li>
                    </ul>
                </li>
<li id="newsletter"><a class="top"><?php echo $text_newsletter; ?></a>
			<ul>			
...
<li id="promotion"><a class="top"><?php echo $text_promotion; ?></a>
			<ul>			
                    ...
                    <ul>
                        ...
                        <li><a class="parent"><?php echo $text_design; ?></a>
                            <ul>
                                ...
                                <li><a href="<?php echo $common_img; ?>"><?php echo $text_common_img; ?></a></li>
                                <li><a href="<?php echo $common_news; ?>"><?php echo $text_common_news; ?></a></li>
                                <li><a href="<?php echo $random_news; ?>"><?php echo $text_random_news; ?></a></li>
                            </ul>
                        </li>
